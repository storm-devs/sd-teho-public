...
void GenerateRumour()
{
    ...
    ///////////////////////////////////////Золотой флот///////////////////////////////////////////////
    if (isGoldFleet == 0 && Colonies[FindColony("Havana")].nation == SPAIN && Colonies[FindColony("PortoBello")].nation == SPAIN && rand(5) == 0)
    {
    ...
    ////////////////////////////////////////Цены в магазине////////////////////////////////////////////
    if (rand(5) == 0)
        AddTemplRumour("GetColonyPrices", id_counter + 1);
    //////////////////////////////////////////////////////////////////////////////////////////////////
    /* aref aData;
