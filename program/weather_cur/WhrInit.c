...
int InitWeather()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        {
            Weathers[i].Rain.DropsSize = 0.07;
        };
        if (!CheckAttribute(&Weathers[i], "Rain.DropsTexture"))
        {
            Weathers[i].Rain.DropsTexture = "weather\rain_drops.tga";
        };
