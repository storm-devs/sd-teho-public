...
void ProcessDialogEvent()
{
    ...
    if (CheckAttribute(aData, "nation"))
    {
        ...
        {
        case 0:
            fort = "Английским фортом";
            break;
        case 1:
            fort = "Французским фортом";
            break;
        case 2:
            fort = "Испанским фортом";
            break;
        case 3:
            fort = "Голландским фортом";
            break;
        case 4:
            fort = "Пиратским фортом";
            break;
        }
...
string GetNumShips(int ship)
{
    ...
    {
    case 0:
        numships = "ни одного корабля";
        break;
    case 1:
        numships = "один корабль";
        break;
    case 2:
        numships = "два корабля";
        break;
    case 3:
        numships = "три корабля";
        break;
    case 4:
        numships = "четыре корабля";
        break;
    case 5:
        numships = "пять кораблей";
        break;
    case 6:
        numships = "шесть кораблей";
        break;
    }
    return numships;
}
...
string GetPart(int part)
{
    ...
    case 1:
        ...
        break;
    case 2:
        numpart = "половину добычи";
        break;
    case 3:
        numpart = "треть добычи";
        break;
    case 4:
        numpart = "четверть добычи";
        break;
    }
    return numpart;
}
