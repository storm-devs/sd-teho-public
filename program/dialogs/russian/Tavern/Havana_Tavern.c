...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Havana_ratT_2":
			dialog.text = "А зачем он тебе? Он чужаков боится - вечно прячется ото всех, как увидит вооруженного незнакомца - за шпагу хватается. Ходит только в сопровождении четырех охранников. Не от тебя ли он так бережётся?";
		...
		// калеуче
		case "caleuche":
			dialog.text = "Черт его знает, дружище. Может, и прибывал, да вот только я о нём ничего не знаю. Уж извини.";
