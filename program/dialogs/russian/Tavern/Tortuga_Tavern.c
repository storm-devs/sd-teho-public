...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		// Addon 2016-1 Jason Пиратская линейка
		case "mtraxx_jew":
            dialog.text = "Смотрю, Гаспар становится всё популярней и популярней у вашей братии... Его дом находится у городской стены. Выйдешь из таверны, повернешь налево, пройдешь в сторону порта, не выходя в порт еще раз налево, до упора прямо и затем направо. Двухэтажный особняк.";
