...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Jamaica_ratW_2":
            ...
            link.l1 = "Ничего смешного, малышка. Мы договорились с ним встретиться на Ямайке, а дальше нас ждет совместный рейс... Если ты понимаешь, о чём я. Мне в одиночку не справиться, а он взял и свалил неизвестно куда!";
