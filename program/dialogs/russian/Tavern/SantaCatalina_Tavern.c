...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Svenson_3":
			dialog.text = "Пропала его любимица Элен, по прозвищу Румба, дочь старого приятеля по лихим годам Шона Мак Артура, упокой Господь его душу. Своих детей у него нет, так он привязался к этой чертовке, как к собственной дочери. И вот неделю назад наша Румба пропала вместе со своей шхуной 'Радугой' и командой\nЖаль девчонку. Редкая красавица и умница, каких мало. Не даром её прозвали Румбой, огонь, а не девка! Отец успел многому её научить, 'Радуга' досталась ей в наследство, так из команды никто не списался на берег, и даже старые морские волки признали её своим капитаном...";
			link.l1 = "Что могло с ними случиться?";
			link.l1.go = "Svenson_4";			
		break;
		
		case "Svenson_4":
			dialog.text = "Кто же знает... Неделя – срок небольшой, но вдова Мак Артура Глэдис уверена, что с её дочерью случилось что-то скверное и смогла убедить в этом Свенсона. Тот поднял на ноги своих людей, но пока безрезультатно. 'Радуга' и все, кто были на ней, как в воду канули\nЗа тысячу песо скажу, где найти тетушку Глэдис.";
