...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    case "quests":
        ...
        {
            link.l1 = "Я принес все необходимое для моего праздника.";
    ...
    case "Sharlie_rum_6":
        dialog.text = "Вот ваша награда - пять тысяч. Подзорную трубу оставьте себе. И еще маленький презент - возьмите эти три бутылки рома. После того, как вы его попробуете, вы сразу поймете, почему на него такой спрос.";
    ...
    case "Portugal_2":
        ...
        link.l1 = "Знаю, " + npchar.name + ", ты не герой, и правильно. Что ты еще видел? Куда они направились?";
        link.l1.go = "Portugal_3";
        break;

    case "Portugal_3":
        dialog.text = "Да вроде ничего больше... хотя, нет! Постойте, одноглазый говорил что-то про повозку. Вроде как повозку они наняли, вашего друга куда-то на другую сторону острова везти. Вот и все, клянусь мсье... я бы стражу вызвал, но этот шепелявый на прощание сказал, что у меня красивая жена... Понимаете? Если они узнают, что я вам все рассказал они же её...";
        if (pchar.money >= 1000)
        {
    ...
    case "Portugal_4":
        ...
        dialog.text = "Спасибо, мсье. Ваш друг, к слову -  он почти поправился, во всяком случае, шел сам. А второй человек – ну, этот тихий голландец – он как раз заходил с улицы – заприметил эту свору и сиганул наружу, только его и видели.";
    ...
    case "LH_tavern_SP":
        ...
        dialog.text = "Да, ваша помощница забегала, но я сказал ей и повторю вам - мне не привыкать к толпам пьяных моряков, но я знаю чем это чревато. То что здесь останется  к утру будет напоминать Рим, после захвата Карлом V. Хорошо, если сама таверна устоит. Так что, если хотите утроить массовый дебош - мне потребуется невозвратный залог сверх того, что вы уже принесли. На случай последствий, так сказать.";
        link.l1 = "Ну и хитрый ты лис! Я сам не первый год пью с морскими волками, бывал в разных... заведениях, и знаю, что за те деньги, что я принес, такой портовый притон можно отстроить заново с фундамента. Пользуешься поводом, так? Ладно, у меня свадьба, и я не настроен мелочиться - сколько ты хочешь сверху?";
        link.l1.go = "LH_tavern_SP_1";
        break;

    case "LH_tavern_SP_1":
        dialog.text = "Ещё ста тысяч должно хватить и не переживайте - сделаю все в лучшем виде. Ваши парни надолго запомнят эту гулянку, попомните мое слово!";
        ...
        {
            link.l1 = "Да я будто графский прием заказываю! Потерпи, я скоро вернусь.";
    ...
    case "LH_tavern_SP_3":
        dialog.text = "Отлично! Ваши парни надолго запомнят эту гулянку, попомните мое слово!";
        link.l1 = "Ты уж постарайся - повод особенный, сам понимаешь. И да, потом не приходи ко мне с жалобами, даже если твой трактир сгорит дотла.";
        link.l1.go = "LH_tavern_SP_4";
        break;
