...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
            ...
            {
                link.l1 = "Послушай, я ищу человека по имени Бертран Пинетт, не слыхал о таком? Он недавно прибыл в Панаму. Солидный такой господин, в парике крученом. Может, заходил к тебе...";
                link.l1.go = "FMQG";
            }
		break;
		...
		case "FMQG_1":
			dialog.text = "Сеньора де Мильяра? Сей идальго Панаму навещал с год назад, на военном построении. А так дон Карлос де Мильяр живет в Порто-Белло. Большой друг тамошнего губернатора.";
