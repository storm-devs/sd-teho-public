...
//---------------------------------------------против всех----------------------------------------------
		...
		case "Fleetwood_soldier"://для любителей сунуть нос куда не надо
			...
			{
			dialog.text = "Опять вы? Да что же вы тут все вынюхиваете? Не нравится мне всё это... Вот что: я вас арестую, и отправлю на разбирательство в комендатуру. Ребята, взять этого типа!";
		...
		case "Stivesant_4":
			...
			link.l1 = "Минхер, кроме простых отчетов курьер вёз и более важные документы Компании. Все они теперь в руках у англичан. Поэтому я принял решение о смещении Бека и взял его под стражу.";
		...
		case "Stivesant_6":
			...
			link.l1 = "Ну что же, я не возражаю. Втроём, так втроём.";
		...
		case "MC_Diag":
			dialog.text = "Роденбург лжёт. Ричард Флитвуд не мог напасть на курьерскую бригантину.";
		...
		case "MC_Diag_1":
			...
			dialog.text = "Моё имя - " + GetFullName(sld) + ". Я лично уничтожил капитана Флитвуда, организовав негодяю ловушку. Сейчас его останки доедают чайки на пустынном берегу Теркса... Я сам положил конец беспределу этого мерзавца, раз официальные власти оказались неспособны защитить нас, голландских торговых капитанов, от его произвола. И случилось это ДО того, как была ограблена курьерская бригантина\nФлитвуд просто не смог бы этого сделать, поскольку был уже мёртв. Узнав в таверне Виллемстада от моряков о захвате курьерского корабля, а также о том, что Матиас Бек арестован, я решил докопаться до сути дела, ибо, как мне было известно, минхер Бек - человек кристально чистой репутации\nПоговорив с матросами в порту, я узнал, что вы расквартировали с вашей шебеки гвардейцев Компании и набрали команду из негодяев всех мастей. Я отправился в море, проследил за вашим кораблём, и, улучив момент, захватил его. Перебив свору нанятых вами головорезов, я допросил китайца Лонгвэя - капитана шебеки. В обмен на свободу он раскрыл все ваши карты, минхер Роденбург\nВы решили узурпировать власть на Кюрасао, а Лонгвэю приказали потопить галеон минхера Стайвесанта. Зная ваши методы, я уверен, что капитан бригантины отбыл не в Филипсбург, а прямиком на дно. Ведь это вы сами организовали нападение на бригантину Компании, чтобы создать прецедент, не так ли? И сделали это при помощи вашего наёмного убийцы Якоба ван Берга, о котором мне также поведал Лонгвэй?";
			link.l1 = "Это... это наглая ложь! Что вы несёте, сударь?! Вы кто вообще такой?!";
		...
		case "Stivesant_23":
			dialog.text = "Я не буду вас задерживать, капитан, вы же человек военный, у вас наверняка много дел, да и шевалье, уверен, с нетерпением ждет вашего возвращения. Будьте так любезны подождать прямо здесь, в приёмной, два часа, и я подготовлю вам ответ на депешу. Присядьте, отдохните, сейчас вам принесут рому или вина, как пожелаете...";
