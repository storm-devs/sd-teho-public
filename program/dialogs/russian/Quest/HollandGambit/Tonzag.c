...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SJ_talk_1":
			dialog.text = "После твоего отбытия, я буквально на следующий день получил известия, что Флитвуд значительно усилил охрану своего дома. Предполагая, что за этим может крыться некая ловушка, или что-то подобное, я немедленно на своём люггере выдвинулся на Антигуа. И, как видишь, не зря.";
		...
		case "SJ_talk_7":
			dialog.text = "Не переживай по поводу этого. Когда твою лоханку взяли под стражу, я собрал весь твой офицерский состав и часть матросов на своём люггере. Они знают, что ты жив и остались на службе. В качестве награды за журнал я передаю тебе в постоянное пользование свой люггер.";
