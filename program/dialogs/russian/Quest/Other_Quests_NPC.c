...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case "Node_rat_1":
			...
			link.l1 = "Сдается мне, что ты лжёшь. Сейчас мы обыщем дом и посмотрим...";
		...
		case "Rat_lover_2":
    		...
    		link.l1 = "Ладно, похоже ты не врёшь. Сиди тихо и не дергайся. А вообще, знакомых надо с умом выбирать. Хотя, какой у тебя ум - по глазам вижу, дура-дурой.";
	...
	//Jason --> ----------------------------------- Неудачливый вор --------------------------------------------
		...
		case "Device_poorman_1":
			switch (sti(pchar.GenQuest.Device.Shipyarder.Chance3))
			{
				...
				{
					dialog.text = "Помилуйте, господин! Да, я стащил на верфи эту странную железку. Но я даже не смог её никому продать - никому она оказалась не нужна. Я её и выбросил. Пощадите, сударь, я просто очень хотел кушать... иначе я никогда бы не решился на кражу!";
				...
				{
					dialog.text = "Помилуйте, господин! Да, я стащил на верфи эту странную железку. Но я даже не смог её никому продать - никому она оказалась не нужна. Я отдам её вам. Вот, берите, только не трогайте меня и не сдавайте солдатам!";
		...
		case "Device_poorman_0_1"://идем на поиски
			dialog.text = "Да сразу за городскими воротами, у выхода в джунгли. Помилуйте, великодушный господин! Если она вам так нужна - забирайте её, она там так и валяется, я уверен.";
			link.l1 = "Надо было бы заставить тебя самого пойти разыскать и принести, да боюсь, дольше потом тебя искать придётся, чем "+pchar.GenQuest.Device.Shipyarder.Type+". Сам найду. Но смотри: если солгал - из под земли достану!";
			link.l1.go = "exit";
		...
		case "Device_poorman_1_3":
			...
			{
				dialog.text = "Капитан, какая стража? Тут только мы с вами. Ну, а раз вы так взъерепенились, то мне не остаётся ничего иного, как немножко вас успокоть... сталью моего клинка.";
		...
		case "Device_poorman_2_1":
			...
			link.l1 = "Значит так: или ты мне сейчас добровольно отдаёшь то, что украл с верфи, или я отведу тебя в комендатуру. Там ты всё равно с этой вещью расстанешься, правда, после легкого прижигания пяток калёным железом. А может, ещё и вздернут потом. Так что выбирай.";
