void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "MarchCap_1":
			...
			switch (rand(2))
			{
				...
				case 2: //одиночный пиратский кулсейлор у бухты, установка параметров
					...
					link.l2 = "Хм. Сдается мне, что эта добыча не только вам в одиночку, но и нам вдвоём не по зубам. Нет, я на такое не подпишусь. Прощайте, сударь, и даже не пытайтесь меня задерживать!";
					link.l2.go = "MarchCap_exit";
				break;
			}
		break;
		...
		case "MarchCap_Deck_continue":
			dialog.text = "Всё возможно, капитан. Если подвернётся денежное дельце, с которым я не смогу справиться сам - я постараюсь найти вас. Вы мне тоже кажетесь надёжным боевым товарищем.";
		...
		case "MarchCap_DieHard":
			...
			link.l1 = "А что, по-вашему, я должен был дать этому пирату потопить моё судно? Нет уж, лучше быть живым трусом, чем мёртвым идиотом!";
