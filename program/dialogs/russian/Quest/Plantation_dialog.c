...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "PegYou":
			PlaySound("VOICE\Russian\soldier_arest_2.wav");
            dialog.text = "Торговых сделок? Ха-ха! Меня не проведёшь! Да от тебя на милю несет "+NationNameAblative(sti(GetBaseHeroNation()))+"! Шпионишь, мерзавец? Пора тебе познакомиться с нашим комендантом.";
