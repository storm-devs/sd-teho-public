...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "girl":
			...
			link.l1 = "Приветсвую, мадемуазель. Спасибо за теплый прием. Но как так? Мне казалось, что настолько значимую колонию французской короны должны регулярно удостаивать визитом люди много достойнее меня.";
			link.l1.go = "girl_1";
		break;
		...
		case "girl_2":
			dialog.text = "Хи-хи. Может вы заглянете к нам часам к шести вечера сегодня? В комнате для слуг жена губернатора регулярно устраивает неформальные вечера. Очень редко удается заполучить на такой вечер интересного собеседника. Вы придете? Пожалуйста, приходите, мы будем вам так рады.";
		...
		case "girl_exit":
			dialog.text = "Очень жаль. Придется найти другого... собеседника. Прощайте.";
		...
		case "girl_5":
			...
			link.l1 = "И тебе привет, красотка. Как видишь, один до вас все-таки добрался. Дел - море, но ваш прекрасный остров наверняка может предложить достаточно развелечений для морского волка вроде меня.";
			link.l1.go = "girl_6";
		break;
		...
		case "girl_8":
			dialog.text = "Чуть позже. Я работаю служанкой во дворце нашего губернатора. Приходи к шести вечера в будуар на втором этаже. Расскажешь нам с подругой о своих приключениях, правда?";
		...
		case "wife_1":
			dialog.text = "Нет нужды в других гостях сегодня. Давайте пить вино и общаться. Ах, вы знаете, как скучно и одиноко мне здесь! Это же деревня с пиратами! Пиратами! Наконец-то в нашем доме честный и утонченный человек! Ах, если бы только мой муж вел дела с людьми ваших талантов и вашего полета! Пираты везде! А вы слышали о новом фасоне, который сейчас в моде при дворе Его Величества? Что вы вообще об этом думаете?";
			link.l1 = "О чем конкретно, простите? О пиратах? Или о фасонах?";
			link.l1.go = "wife_2";
		break;
		
		case "wife_2":
			dialog.text = "Вы так меня понимаете! Даже не верится. Можете себе представить, но мой муж дает мне на жизнь жалкие крохи, хотя сам имеет со своих пиратов миллионы! Пираты! Я вынуждена заказывать платья прямо здесь, в этой дыре, но разве может дама моего статуса носить эти лохмотья! Как я хочу увидеть вживую эти фасоны из самого Парижа! Как вы думаете, я была бы в них прекрасна?";
		...
		case "wife_4":
			...
			dialog.text = "Будьте осторожны, месье капитан, а то я могу потерять голову. Хи-хи. Как бы вам сказать... Мой муж не выделяет мне ни сантима последнее время, этот мерзавец водит к себе распутных женщин и совсем забыл про меня\nЯ точно знаю, что он хранит крошечную часть своих богатств в сундуке в своем кабинете. Это и мои деньги. По праву жены и по праву женщины. Помогите мне получить то, что мне причитается и будете вознаграждены... Золотом и... кто знает.";
			link.l1 = "Это... интересное предложение. Хорошо, мадам, я вам помогу. Где этот сундук и как его открыть?";
			link.l1.go = "wife_5";
			link.l2 = "Хорошо, красавица, я добуду содержимое сундука. Мы получим деньги и очень приятно проведем время. Какой мужчина от такого откажется? Где этот сундкук и как его открыть?";
			link.l2.go = "wife_6";
			link.l3 = "Простите, мадам, но честь не позволит мне сделать этого. Я вам сочувствую, вы заслуживаете большего, но вам придется найти себе другого исполнителя.";
		...
		case "wife_8":
			...
			link.l1 = "Удивлен, мадам. Но я совершенно не против. Развлечемся? Или у вас ко мне есть деловое предложение?";
			link.l1.go = "wife_9";
		break;
		...
		case "wife_12":
			...
			link.l1.go = "wife_13";
			link.l2 = "Ха! Ради такой женщины, я сделаю это. Ты не пожалеешь, красотка. Мы получим деньги и очень приятно проведем время. Где этот сундкук и как его открыть?";
			link.l2.go = "wife_14";
		...
		case "wife_14":
			pchar.questTemp.FMQT.Bed = "true"; // вар 2 
			dialog.text = "Держи себя в руках, милый. Хи-хи.  Сначала нужно вернуть дубликат ключа, который оказался в руках мерзкого пирата. Он сейчас сидит в местном притоне и напивается, как животное. Поторопитесь и верните мне дубликат. Справишься?";
		...
		case "wife_16":
			dialog.text = "О, боже! Неужели этот мерзавец получит по заслугам! Вы невероятный человек, капитан! У вас большое будущее впереди, вы ведь это знаете? Забудьте про сундук. Я сама всё сделаю. Приходите завтра и вас ждет награда. Вы не пожалеете, мой капитан...";
		...
		case "wife_18":
			dialog.text = " Вы уверены? Это может небезопасно. Зачем вам такой риск, мой капитан? Передумайте, молю вас!";
			link.l1 = "Хорошо. Будь по вашему. С нетерпением буду ждать завтрашнего дня.";
			link.l1.go = "wife_17";
			link.l2 = "Я твердо решил. Что нужно делать?";
			link.l2.go = "wife_19";
		break;
		
		case "wife_19":
			dialog.text = "Храбрец!.. Идите в кабинет моего мужа. В нем к одному из сундуков подойдет этот дубликат. В кабинете никого не будет. Там, в сундуке... бриллианты. Много... Забирайте всё и возвращайтесь ко мне. Я буду ждать. Вы не обманете бедную женщину, я это знаю...";
		...
		case "wife_22":
			dialog.text = "О, боже! Капитан, вы меня спасли! Вы... ты мой мужчина! Это был головорез моего мужа, он хотел убить тебя! Я умоляла его не делать этого! Ты ранен? Ты принес бриллианты?";
			link.l1 = "Ха. Даже так? А ваш муж на редкость деликатный человек... Ну и черт с ним. Камешки у меня.";
			link.l1.go = "wife_23";
		break;
		...
		case "wife_23":
			...
			{
				link.l1 = "Там было две сотни блестящих камушков - алмазов, но ты не получишь ни одного. Ты подослала ко мне наемного убийцу, дрянь! И ты думаешь, я стану с тобой теперь делится? А раскроешь рот - твой муженек сразу узнает, что ты затевала. Так что сиди тихо...";
				link.l1.go = "wife_24";
			}
		break;
		
		case "wife_24":
			dialog.text = "Подлец! Негодяй! Это тебе даром не пройдет!";
			link.l1 = "Ну-ну...";
			link.l1.go = "exit";
		...
		case "wife_25":
			...
			dialog.text = "Вы не такой как... все остальные. Вы добиваетесь того, что хотите. У вас огромное будущее, вам надо спешить, но... Побудете со мной еще немного? Нам никто не помешает, обещаю.";
		...
		case "wife_28":
			dialog.text = "Вы о чем, месье? Я замужняя женщина, и посторонним мужчинам встреч не назначаю! Немедленно покиньте мой будуар, иначе я позову мужа и стражу!";
			link.l1 = "Ах вот как мы запели! Ну ничего, твой муженек обо всем узнает!";
			link.l1.go = "wife_29";
		break;
		
		case "wife_29":
			dialog.text = "Если вы немедленно не уберетесь, наглец, вас отправят в самую сырую и темную камеру подземелья Ля Роша! А ваши угрозы меня не волнуют. Вон!!";
			link.l1 = "...";
			link.l1.go = "wife_30";
		break;
		...
		case "pirate_1":
			...
			link.l1 = "За твое здоровье!.. Послушай, приятель, тянуть не буду. Мне нужен дубликат, ты сам знаешь какой. Отдай его мне и разойдемся: ты продолжишь пить, а я продолжу помогать дамам в беде.";
			link.l1.go = "pirate_2";
		break;
		
		case "pirate_2":
			dialog.text = "Забавно, а ты выглядишь умнее, чем есть на самом деле. Работаешь на эту стерву? А ты знаешь, кто её муж? Я тоже думал, что знаю. Левассер недавно послал своего раба Кампачо избить какого-то уважаемого торгаша за то, что тот не оказал должного внимания его жене. И эта баба меня завлекла своими прелестями и его дублонами\nДубликат существует. Я был неплохим медвежатником на родине и сделал слепок ключа. Если бы не дочка коменданта Лиона... я бы никогда не стал пиратом. К черту!";
			link.l1 = "Всё это очень печально, но давай к делу. Где дубликат?";
			link.l1.go = "pirate_3";
		break;
		
		case "pirate_3":
			dialog.text = "Ты меня не слушаешь?! Я больше не в деле! Мне хватило ума понять, чем это всё закончится! Когда мой корабль будет готов к отплытию, я свалю с этого острова навсегда. Хочешь дубликат? Заплати. И не жадничай, шансы таковы, что деньги тебе больше могут не понадобится.";
		...
		case "pirate_4":
			dialog.text = "Все-таки мозгами тебя Господь не обделил. Правильное решение, дружище. Удачи. Надеюсь, ты однажды найдешь себе настоящую, любящую женщину.";
		...
		case "pirate_6":
			...
			link.l1 = "Пятьдесят дублонов? Тебе? Обойдешься. Дубликат. На стол.";
			link.l1.go = "pirate_7";
		...
		case "pirate_dublon":
			dialog.text = "Принес пятьдесят дублонов?";
			link.l1 = "Знаешь, я подумал, что ты обойдешься. Дубликат. На стол.";
			link.l1.go = "pirate_7";
			if (GetCharacterItem(pchar, "gold_dublon") >= 50)
			{
				link.l2 = "Да. Держи.";
		...
		case "pirate_8":
			...
			PlaySound("interface\important_item.wav");
			dialog.text = "Отлично. Если твои мозги не подведут, то выйдешь из этого живым и с прибылью. Держи дубликат и совет. Совет бесплатный. Женушка нашего Левассера тупа, как пробка, но считает себя хитрой. Не доверяй ей. Держи себя в руках и следи за карманами в случае чего. Противник из неё никакой, просто будь осторожен и не вмешивай её мужа\nИ еще, у неё в будуаре есть сундук. Открыть - пара пустяков. Там хранятся её побрякушки. Ты меня услышал. Удачи в море, брат.";
			link.l1 = "Бывай, приятель...";
			link.l1.go = "pirate_9";
		break;
		...
		case "mercen":
			...
			dialog.text = "Каналья! Не ожидал... Чертовы бабы! Говорил мне наставник - не связываться с такими, как она. Но работа есть работа. Я тебя все же достану!";
			link.l1 = "Так-так, приятель... Похоже, она и меня поиметь решила, не скажу, что я удивлен. Зачем нам драться? Нужна работа? Она есть. Парень ты опытный, мне в команду такие нужны. Стол, койка, жалованье и честная доля добычи. Что скажешь?";
		...
		case "mercen_4":
			dialog.text = "Сладко поешь. Но недостаточно сладко для того, чтобы получить к себе на службу профессионала. Учти это в будущем. Если доживешь.";
			link.l1 = "Ну попробуй. Только побыстрее, у меня свидание с дамой.";
			link.l1.go = "mercen_5";
			link.l2 = "Второго шанса не будет. У меня еще куча дел, так что давай не будем дальше пачкать пол. Тебе не настолько хорошо платят за эту работу, чтобы подыхать ради местной шлюхи. Или тебе еще даже не заплатили?";
			link.l2.go = "mercen_6";
		break;
		...
		case "mercen_6":
			dialog.text = "Тут ты прав. ПОКА мне еще никто не платил, и надо это исправить. Делай, что хочешь...";
			link.l1 = "...";
			link.l1.go = "mercen_7";
		break;
