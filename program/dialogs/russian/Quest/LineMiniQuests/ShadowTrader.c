...
void ProcessDialogEvent()
{
    ...
    case "ShadowTrader":
        dialog.text = "Доброй ночи, господин. Приятно познакомиться с новым клиентом, хе-хе. Представимся: меня зовут " + GetFullName(npchar) + ". У меня самые дешёвые товары в этом городе, смею уверить.";
