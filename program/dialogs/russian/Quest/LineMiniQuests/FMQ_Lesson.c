...
void ProcessDialogEvent()
{
    ...
    case "prosper_12":
        ...
        if (CheckAttribute(pchar, "questTemp.FMQL.PirateDead"))
            sTemp = "Жаль этого парня, хоть он и пират.";
        ...
        link.l1 = "И все же благодарю тебя, Проспер! Тут было слишком жарко... Хочешь пойти ко мне в команду? Мне нужен такой офицер, как ты. Верных людей сложно найти, а верных стрелков ещё сложнее.";
