void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Wine_fort":
			dialog.text = "Ну что, принёс бутылочку?";
		...
		case "Wine_fort_1":
			...
			dialog.text = "Аргх, спасибо тебе, дружище! Вот, держи свою тысячу, а эта бутылочка теперь моя, ха-ха-ха! Послушай, раз уже такое дело пошло, то у меня к тебе будет ещё одна просьба\nНе мог бы ты раздобыть в городе ещё вина, для меня и всех моих друзей, про запас? Мы тут недавно хорошо контрабандистов пощипали, так что деньги у нас имеются, хе-хе...";
	...
	break;
		...
		case "Wine_take":
			...
			if (sti(pchar.items.potionwine) > 60)
			{
				...
				link.l1 = "Забирайте. Уверен, вы с друзьями неплохо отдохнёте!";
