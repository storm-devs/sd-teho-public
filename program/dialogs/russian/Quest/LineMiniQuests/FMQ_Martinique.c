...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "carpenter_1":
			...
			link.l1 = "Да, я действительно приобрел этот корабль. Так что вы хотели, месье "+GetFullName(npchar)+"?";
		...
		case "officer_1":
			dialog.text = "И не пытайтесь здесь отпираться! В подсобном помещении верфи стоит несколько десятков бочек с природной смолой. Вы, капитан, ее привезли и сбыли своему сообщнику. Вы оба арестованы, а товар я конфискую, именем закона!";
			link.l1 = "...";
		...
		case "officer_5":
			...
			dialog.text = "Эта смола, дорогой 'мастер-корабел', является стратегическим товаром, и ее оборот находится под строгим контролем губернатора! Но раз вы утверждаете, что это ваша смола - будь по-вашему. Вы арестованы, месье "+GetFullName(characterFromId("FortFrance_shipyarder"))+", и сейчас отправитесь за решетку, а завтра дадите объяснения, откуда у вас взялись эти бочки! И не беспокойтесь, мы во всем разберемся! А вы, капитан, можете быть свободны. Сегодня вам повезло.";
			link.l1 = "";
		...
		case "officer_9":
			dialog.text = "Хорошо. Я отдам вам вашу смолу. Но у меня ее ровно половина от того количества, которое вы привезли в Сен-Пьер. Надеюсь, вас это удовлетворит, ибо большего предложить я не могу.";
			link.l1 = "Вы меня продолжаете держать за дурака? Нет второй половины - компенсируйте ее стоимость деньгами, или теми товарами, что лежат в куче у меня за спиной.";
			link.l1.go = "officer_10";
		break;
		
		case "officer_10":
			dialog.text = "Это исключено. По поводу второй половины обращайтесь к известному вам лицу.";
			link.l1 = "Вы издеваетесь? Вы серьезно полагаете, что "+GetFullName(characterFromId("FortFrance_shipyarder"))+" отдаст мне мои бочки? Не смешите меня!";
			link.l1.go = "officer_11";
		break;
		
		case "officer_11":
			dialog.text = "Капитан, забирайте какую есть смолу и свою жизнь впридачу, и убирайтесь прочь. К этой сделке я добавляю свое обещание не чинить вам козней в Сен-Пьере. Большего вы не получите.";
			link.l1 = "Вы дарите мне мою жизнь? Ха-ха!";
			link.l1.go = "officer_12";
		break;
		
		case "officer_12":
			dialog.text = "Похоже, вы еще разгорячены после схватки, капитан. Разъясняю: вы уложили шайку салаг, но против моего отряда у вас шансов нет. Я мог бы вас спокойно прирезать в этой бухте, не предлагая никаких сделок, но мне дороги мои люди, которые могут случайно погибнуть или получить ранение, пока будут убивать вас. Так что или вы принимаете мое весьма щедрое предложение, или останетесь здесь навсегда. Выбирайте.";
			link.l1 = "Черт вас подери, лейтенант, но я вынужден согласиться. Похоже, что сила не на моей стороне.";
			link.l1.go = "officer_13";
			link.l2 = "Вы весьма самонадеянны, лейтенант. Пожалуй, стоит преподать вам и вашим наемникам хороший урок, смоленый пес!";
			link.l2.go = "officer_15";
		break;
		
		case "officer_13":
			dialog.text = "Вы разумный человек, капитан. Забирайте свои бочонки и отчаливайте. Предупреждаю сразу - доносить на меня губернатору смысла не имеет. Сегодня же мой схрон будет перенесен в другое место. Так что не тратьте свое время напрасно.";
		...
		case "greguar_3":
			dialog.text = "Монсеньор, давайте не будем стоять посреди улицы, а пойдем в таверну. Выпьем по кружечке. Там и поведаете, что у вас за беда. Ну же, идемте!";
			link.l1 = "...";
		...
		case "greguar_7":
			dialog.text = "Капитан, мне вы можете рассказывать все, что угодно. Я не побегу доносить на вас коменданту или губернатору, уж поверьте. Или вы сомневаетесь?";
		...
		case "greguar_8":
			...
			link.l1 = "Корабел с местной верфи нуждался в особом товаре - смолах, и нанял меня 'пощипать' караван испанцев из Порт-оф-Спейна. Обещал хорошо заплатить, по полтора десятка дублонов за бочку. Я отыскал этот конвой, отбил 'испанца' со смолами, привез товар сюда. Судно мое поставили в доки на ремонт и попутно выгрузили бочонки на верфь. И только мы закончили - врывается этот офицер... И как он пронюхал?";
			link.l1.go = "greguar_9";
		break;
		
		case "greguar_9":
			dialog.text = "";
			link.l1 = "Короче, накрыли нас с поличным. Надо отдать должное корабелу - он взял все на себя, сказал, что это его смолы, а я ни при чем. В итоге мастера арестовали, увели, а денежки мои плакали. Весь сыр-бор с испанским караваном был напрасен. Ладно, хоть тюрьмой дело не закончилось. Наливайте еще, месье Грегуар.";
			link.l1.go = "greguar_10";
		break;
		
		case "greguar_10":
			dialog.text = "Так что - мастер-корабел арестован?";
			link.l1 = "Ну да. Его вел тот самый офицер, они вышли из здания верфи передо мной. Вы должны были их видеть.";
		...
		case "greguar_13":
			dialog.text = "Похоже, мой дорогой "+pchar.name+", перед вами разыграли спектакль в расчете на то, что вы тут человек новый. Бьюсь об заклад на сотню золотых дублонов, что не пройдет и трех дней, как месье "+GetFullName(characterFromId("FortFrance_shipyarder"))+" будет спокойно расхаживать по своей верфи.";
		...
		case "greguar_14":
			dialog.text = "Это Карибы, месье "+pchar.name+". Привыкайте. Внешний вид ни о чем не говорит - самые отъявленные мерзавцы одеты в камзолы и кружева.";
			link.l1 = "Где-то я уже это слышал... Но что же мне сделать с этими жуликами? Пойти, доложить губернатору?";
			link.l1.go = "greguar_15";
		break;
		
		case "greguar_15":
			dialog.text = "Боюсь, что в этом случае месье "+GetFullName(characterFromId("FortFrance_shipyarder"))+" внезапно перестанет вас выгораживать, и пойдете вы, как соучастник.";
		...
		case "greguar_16":
			...
			link.l1 = "Мы еще посмотрим. Спасибо, что раскрыли мне глаза, монсеньор. Очень хорошо, что я вас встретил.";
			link.l1.go = "greguar_17";
		break;
		
		case "greguar_17":
			dialog.text = "Будьте осторожны, месье. Помните, что я вам сказал.";
			link.l1 = "Я учту это. А теперь выпьем еще по кружечке - и пора на боковую!";
			link.l1.go = "exit";
		...
		case "pirate":
			...
			link.l1 = "Приятель, я пришел за своим добром. В бочках, стоящих у вон той кучи - моя смола, которую я добыл и за которую мне не заплатили.";
			link.l1.go = "pirate_1";
		break;
