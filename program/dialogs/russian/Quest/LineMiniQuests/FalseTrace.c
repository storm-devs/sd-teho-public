void ProcessDialogEvent()
{
    ...
    case "FalseTrace_13":
        dialog.text = "Потому что я ей ещё не располагаю. Позвольте объяснить подробно. Один джентльмен удачи, по имени Косой Солли - не слыхали о таком? - за день до нашего с вами отплытия отправился с отрядом из Блювельда в глубь континента, чтобы хорошенько пощипать золотые рудники\nУ берегов Мейна его должно было встретить судно, когда он будет возвращаться с добычей, но по определённым причинам этого не произойдёт, и Косой Солли будет вынужден пешком отправиться в Блювельд, или Белиз - не знаю, куда ближе, за кораблём, чтобы погрузить награбленное\nЕстественно, золото он через джунгли не потащит и спрячет в какой-нибудь бухте и поставит небольшую охрану. У него в отряде есть мой человек. Он будет ждать меня в городе " + XI_ConvertString("Colony" + pchar.questTemp.FalseTrace.QuestCity) + ". Как только мы бросим якорь в порту, он и сообщит мне, в какой бухте Косой Солли спрятал награбленное добро\nВы пойдёте туда, без труда вырежете его бандитов и заберёте себе золото. Я сам собирался сделать это, но учитывая обстоятельства, полностью отдаю это дело вам, и даже не прошу себе ни песо.";
    ...
    case "FalseTrace_25":
        ...
        link.l1 = "По твоей фальшивой наводке я захватил пустой галеон и убил его капитана. Я сожалею, что сделал это, хотя уже поздно. Твоя жена, как я понял, любила этого моряка. Поэтому она заказала тебя. Мне. Вот почему мы здесь втроём, в этой бухте.";
        link.l1.go = "FalseTrace_26";
        break;

    case "FalseTrace_26":
        dialog.text = "Ушам не верю! Катерина... вот ведь маленькая дрянь! Ну доберусь я ещё до тебя... И чем же она пообещала расплатиться с тобой, ты, олух? У неё нет ни гроша, даже украшения свои, которые я ей дарил, она продала, чтобы сбежать с этим капитанишкой!";
    ...
    case "FalseTrace_abordage":
        dialog.text = "Аргх! Какого чёрта ты напал на мой корабль, мерзавец? Вообще в толк не возьму...";
    ...
    case "FalseTrace_wife_8": //ноды пересечения - старт
        dialog.text = "";
        link.l1 = "Молчишь? Замечательно. Выслушай же меня наконец! Я совершил нападение на это судно, потому что у меня были сведения, что оно везёт огромный груз серебра. И сведения эти я получил от Адама Рейнера.";
    ...
    case "FalseTrace_wife_10":
        ...
        link.l1 = "В общем, получилось именно так. Адам солгал мне о грузе серебра, чтобы я захватил галеон '" + pchar.questTemp.FalseTrace.ShipName + "', с очевидной целью вернуть тебя. Четверть часа назад он дал мне полный отчёт о своих дейстиях...";
    ...
    case "FalseTrace_wife_13":
        dialog.text = "(сквозь слезы) Мой муж? А вы знаете, кто он, мой муж? Он бывший заключённый, каторжник, а нынче - самый жестокий бандит " + XI_ConvertString("Colony" + pchar.questTemp.FalseTrace.StartCity + "Gen") + "! Он низкое и грубое животное, а я для него - не больше чем просто... подстилка!";
    ...
    case "FalseTrace_Bandits":
        dialog.text = "А-а, вот и явился убийца Адама! Катерина была права - этот гад пришёл разграбить тайник покойного!";
    ...
    case "FalseTrace_GoldShip_1":
        ...
        link.l1 = "Понятно... Ну что же, " + pchar.questTemp.FalseTrace.CapName + ", прощайте. Наверное, я должен пожелать вам удачи и счастья с Катериной? Надеюсь, у вас всё будет хорошо. Жаль, что мы познакомились с вами при таких печальных обстоятельствах.";
