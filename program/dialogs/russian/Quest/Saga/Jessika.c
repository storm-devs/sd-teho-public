...
void ProcessDialogEvent()
{
    ...
    case "soul_8":
        if (CheckAttribute(pchar, "questTemp.Saga.Helena_friend"))
            ...
            sTemp = "Что же касается дочери Беатрисс, то твои благородные поступки в её отношении так и останутся неоцененными. Скоро ты в этом убедишься. Будь с ней осторожен. Ну а теперь\n";
