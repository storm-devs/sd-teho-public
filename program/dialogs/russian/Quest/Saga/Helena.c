...
void ProcessDialogEvent()
{
    ...
    case "QMASTER_1":
        dialog.Text = "Шарль, дорогой, ты случайно не перегрелся? Я тут не для того чтобы считать крыс.";
        Link.l1 = "О, милая, конечно. Извини мою нерасторопность.";
        Link.l1.go = "exit";
        break;
    ...
    case "GoldenGirl":
        ...
        link.l1 = "Хуже, Элен, хуже. Губернатор намерен посетить крайне дорогую куртизанку, а я при нем в качестве диковинки, обещанной хозяйке. Скучная болтовня, дорогое вино и унылые аристократы.";
    ...
    case "GoldenGirl_13":
        ...
        link.l1 = "Элен, все немного сложнее. Проклятье, прости меня, я не думал, что задержусь настолько, пришлось заночевать в доме мадам Бото. Одному, клянусь! И да, я выиграл в карты отменный фрегат. Представляешь?";
    ...
    case "GoldenGirl_16":
        ...
        link.l1 = "Элен, послушай, ты имеешь право злиться, и мне очень жаль, но все не так просто...";
    ...
    case "GoldenGirl_17":
        ...
        link.l1 = "Элен, да позволь мне все объяснить, наконец! Проклятье... Опять?!";
    ...
    case "GoldenGirl_18":
        ...
        link.l1 = "Элен, все немного сложнее. Проклятье, прости меня, я не думал что задержусь настолько. Этот вечер превратился в форменное сражение за карточными столами. И да, я выиграл в карты отменный фрегат. Представляешь?";
    ...
    case "GoldenGirl_21":
        ...
        link.l1 = "Элен, послушай, ты имеешь право злиться, но все не так просто...";
    ...
    case "GoldenGirl_22":
        ...
        link.l1 = "Элен, все будет хорошо, поверь мне. Постой, ну куда ты?! Проклятье... Опять?!";
        link.l1.go = "GoldenGirl_23";
        break;
    ...
    case "GoldenGirl_24":
        dialog.text = "Шарль, а теперь будь добр, объясни мне: что за чертовщина тут вообще творилась? На корабль среди ночи ворвались какие-то головорезы. Потом этот немытый хмырь, гнусно хихикая, спрашивал меня, на что ты пойдешь, чтобы меня вернуть. А затем меня заперли в кубрике, и я потеряла счет дням!";
    ...
    case "GoldenGirl_26":
        dialog.text = "Уже. И ты прости меня, Шарль. Если бы я не приняла все так близко к сердцу с этой дуэлью и маркизой, и хотя бы расставила вахту на фрегате... Глупо все вышло!";
        link.l1 = "Все вышло как вышло, и это уже в прошлом. Ты вернулась ко мне, и это все, о чем я смел мечтать последние недели. Я многое понял за это время, Элен. Очень многое. Я люблю тебя, и больше никогда не оставлю. Обещаю!";
    ...
    case "GoldenGirl_28_1":
        ...
        {
            dialog.text = "Ну и история вышла... Я верю, что у тебя не было иного выбора, но что теперь будет? Этот британец действительно все уладит, или будем воевать? Не хочешь отправится в Бас Тер и лично полюбоваться как на заносчивого мерзавца оденут цепи?";
            link.l1 = "Знаешь, Элен, пару недель назад я бы ни за что не упустил такой шанс. Но теперь - пусть бастард отправляется к черту! Мне даже плевать поймают его или нет - это все больше не моя проблема. Мы снова вместе - вот что по настоящему важно!";
        }
    ...
    case "GoldenGirl_32":
        dialog.text = "Шарль, ты жив! У тебя получилось!! Португалец мне все рассказал! Ну и история вышла!";
    ...
    case "GoldenGirl_33":
        ...
        link.l1 = "Я... я люблю тебя Элен. А все остальное - неважно.";
        link.l1.go = "GoldenGirl_34";
        break;

    case "GoldenGirl_34":
        dialog.text = "Ну да, это многое объясняет, но... Черт, я тоже, Шарль. Я тоже тебя люблю. Боже, как я скучала!";
    ...
    case "GoldenGirl_36_1":
        ...
        link.l1 = "Нет, Элен, из-за моей глупости. Я должен был тебя вернуть и все исправить.";
    ...
    case "LongHappy":
        ...
        dialog.text = "Прибой и ветер, ты я, хорошее вино - стоило бы почаще вот так выбираться, а Шарль?";
    ...
    case "LongHappy_2":
        ...
        {
            dialog.text = "Конечно да! Шарль, Да, да, и еще раз да! Но... мы же не отправимся в пыльный фамильный замок выращивать репу, до конца дней своих?";
            link.l1 = "Ну, замок имеется и вполне себе пыльный, но мы там не задержимся. Наша жизнь - свобода и горизонт по курсу. И с тобой я хотел бы жить ее вечно!";
    ...
    case "LongHappy_15":
        dialog.text = "Успел отдохнуть, Шарль? Представляешь - местные ребята так разгулялись неделю назад, что сожгли 'Старый Дятел', но барон обещал что к нашему приезду ее отстроят больше и лучше, чем была. Об остальном я договорилась, так что можно отчаливать.";
    ...
    case "LongHappy_26":
        dialog.text = "";
        link.l1 = "Я, Шарль, Анри де Мор, шевалье де Монпе, беру тебя, Элен Беатрисс Шарп, в законные жены, и клянусь хранить верность в счастье и в несчастии, в болезни и в здравии, а так же любить и уважать тебя все отпущенные мне дни.";
    ...
    case "LongHappy_39":
        dialog.text = "Давай, Шарль. Этот брехун и в стену не попадет!";
        link.l1 = "";
    ...
    case "LongHappy_41":
        dialog.text = "Я в порядке, Шарль, все хорошо. Как Натан? Что с ним?";
