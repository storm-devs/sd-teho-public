...
void ProcessDialogEvent()
{
    ...
    case "rozencraft_4":
        ...
        if (iTemp >= 90)
        {
            dialog.text = "Отлично. Это даже больше, чем я ожидал. Вот, держи золото. Если разживёшься ещё бакаутом - приходи в таверну Синт-Маартена и поговори... сам понимаешь с кем. Он сведет тебя со мной. Вижу, с тобой можно вести дела, и получше, чем с этим недоноском Моллиганом.";
        ...
        {
            dialog.text = "Хорошо. Вот, держи золото. Если разживёшься ещё бакаутом - приходи в таверну Филипсбурга и поговори... сам понимаешь с кем. Он сведет тебя со мной. Вижу, с тобой можно вести дела, и не хуже, чем с этим недоноском Моллиганом.";
            link.l1 = "Хорошо. Считай, что мы договорились.";
            link.l1.go = "rozencraft_5";
            pchar.GenQuest.Bakaut = "true"; // генератор сбыта бакаута
            break;
    ...
    case "rozencraft_5":
        ...
        else
        {
            ...
            if (CheckAttribute(pchar, "GenQuest.Bakaut"))
                AddQuestUserData("Testament", "sText", "Кроме того, если я ещё добуду бакаут - я смогу сбыть эту ценную древесину Михаэлю Розенкрафту, договорившись через его человека в таверне Филипсбурга.");
