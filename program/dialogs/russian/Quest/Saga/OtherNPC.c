...
void ProcessDialogEvent()
{
    ...
    case "Jimmy_6":
        dialog.text = "Джимми хитрый! Его на мякине не проведёшь! Я под Румбу давно клинья подбиваю и втихаря выяснил, что Глэдис вышла замуж за Шона Мак Артура как раз двадцать лет назад. А до этого она жила в Белизе. А её первого мужа звали Пит Чандлер\nБеднягу Пита кто-то зашиб по пьяни. Поговаривают, что сам Мак Артур и приложил к этому руку, поскольку запал на толстушку Глэдис. Она стала вдовой с младенцем на руках. Так вот ребёнок этот ненамного пережил своего папашу и помер от лихоманки\nА вскоре Глэдис с Шоном появились в Блювельде с живой девчушкой на руках, которую записали как дочку Мак Артура. Когда она успела родить второго? Сечёшь?";
    ...
    case "Morelle_1":
        ...
        link.l1 = "Хорошо. Я не скажу Барбазону, что ты ещё жив. Если то, что о нем болтают правда, то тебе и впрямь лучше быть повешенным голландцами. А может ещё и каторгой отделаешься.";
    ...
    case "benson_1":
        dialog.text = "Человек мне один хороший доверился, а я пошёл на поводу у команды и выкинул его за борт. Ну не то, чтобы выкинул, все же старый баркас и запас продовольствия оставляют ему шансы, но, признаться, небольшие.";
    ...
    case "mine_attackx_1":
        ...
        if (sTemp == "нептун")
        {
            dialog.text = "Всё верно. Но ты, приятель, пришёл не с той стороны. Разве тебя не предупредили? Топай назад по тропе, потом пройдёшь мимо сухого колодца, возьмешь левее, на тропинку вокруг холма - она тебя приведёт к центральному входу.";
