...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "diffindoor_8":
			...
			link.l1 = "Ты это сейчас о чём? А-а, понятно. Ты, как и Даниэль, решил, что это Свенсон организовал на тебя засаду в сельве? Уверяю, Ян ни при чём. Напротив, он на твоей стороне, и сильно переживает по поводу твоего ичезновения.";
