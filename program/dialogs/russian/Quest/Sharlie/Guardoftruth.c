...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "belinda_12":
			dialog.text = "Я не смела на это надеяться... Но, капитан, Барти Живодер также сказал, что если посланник придёт не один, или я обращусь к коменданту - то они немедленно убьют пленника...";
			link.l1 = "Я учту это.";
		...
		case "barty_13":
			dialog.text = "Пощадите, сеньор! Отпустите меня, я просто уплыву отсюда и никогда более не появлюсь в Кумане! Я не собираюсь дожидаться, пока муж Белинды прикончит меня на дуэли или подошлёт наемного убийцу...";
