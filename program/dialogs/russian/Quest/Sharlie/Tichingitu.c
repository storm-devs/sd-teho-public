...
void ProcessDialogEvent()
{
	...
	//--> ----------------------------------- офицерский блок ------------------------------------------
		...
		/////////////////////////// ответы для казначея ///////////////////////////////////
		case "QMASTER_1":
			dialog.Text = "Отчёт? У Тичингиту нету отчёт, господин. Только оружие и одежда есть. Никакой отчёт Тичингиту нигде не брать.";
			Link.l1 = "Ладно, проехали.";
			Link.l1.go = "exit";
		break;	

		case "QMASTER_2":
			dialog.text = "Господин, Тичингиту без вас в колония больше нога не ступить. А то зайти Тичингиту в магазин - и снова все подумать, что Тичингиту вор. А дальше тюрьма.";
	...
	// на Тайясаль
		case "tieyasal":
			dialog.text = "Жизнь Тичингиту давно стать жизнью моего капитан. Индеец не забывать, что капитан сделать для Тичингиту. Тичингиту идти за ним, куда сказать капитан, без упрёк и колебаний.";
