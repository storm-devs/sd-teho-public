...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ksochitam_10":
			dialog.text = "Легкого пути в Тайясаль, по которому мы проникли туда, уже двадцать лет как не существует - тропы завалены камнями и заросли джунглями. Но есть ещё один проход, долгий и опасный. Это тропа начинает свой бег из бухты на севере Юкатана\nПри помощи отца Винсенто и дона Рамона де Мендосы я соберу отряд отборных солдат, и мы пробьёмся сквозь сельву, охраняемую дикарями ица. Путь будет тяжёл, но Господь дарует нам силы и мужество, ибо мы пойдём на битву во имя нашей веры.";
