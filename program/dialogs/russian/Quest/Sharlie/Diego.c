...
void ProcessDialogEvent()
{
    ...
    case "shore_5":
        ...
        if (CheckAttribute(pchar, "questTemp.Guardoftruth.SanAntonio"))
            link.l1 = "Вы, право, удивили меня, сеньор. Неужели вы и впрямь решили, что я такой набитый дурак, что полезу в пасть к акуле, не позаботившись прихватить с собой гарпун? Отря-яд, к бою!";
        else
            link.l1 = "Воюют не числом, а умением, сеньор!";
        link.l1.go = "shore_6";
        break;
