...
void ProcessDialogEvent()
{
    ...
    case "saga":
        ...
        {
        case "holl_win":
            sTemp = "Я поступил на службу в Голландскую Вест-Индскую Компанию, стал агентом по специальным поручениям и близким другом вице-директора Компании, Лукаса Роденбурга. Мне удалось выполнить несколько серьезных заданий, в частности, ликвидировать того самого английского капера. Кроме того, у меня теперь на Антигуа свой личный дом, и в кармане позвякивают деньжата...";
            break;

        case "holl_fail":
            sTemp = "Я поступил на службу в Голландскую Вест-Индскую Компанию, однако дела у меня пошли неважно, я провалил ответственное задание и был вынужден уйти ни с чем.";
            break;

        case "eng_win":
            sTemp = "Я нашел того самого английского капера, Ричарда Флитвуда, выполнил несколько заданий во славу флота Англии, в частности, ликвидировал пиратский 'корабль-призрак' и разделался с самим Лукасом Роденбургом, вице-директором Компании. Кроме того, у меня теперь на Антигуа свой личный дом, и в кармане позвякивают деньжата...";
            break;

        case "eng_win_half":
            sTemp = "Я нашел того самого английского капера, Ричарда Флитвуда, выполнил несколько заданий во славу флота Англии, в частности, ликвидировал пиратский 'корабль-призрак'. Правда, Флитвуд отбыл в Англию и моя служба у него окончилась, но все же...";
            break;

        case "eng_fail":
            sTemp = "Я поступил на службу к английскому каперу с Антигуа, Ричарду Флитвуду, однако дела у меня пошли неважно, я провалил ответственное задание и был вынужден уйти ни с чем.";
            break;

        case "self_win":
            sTemp = "Я нашел 'тайную организацию' на Барбадосе, стал вести свою собственную игру и добился немалого: уничтожил того английского капера, Ричарда Флитвуда, отправил за решетку Лукаса Роденбурга, вице-директора Компании, стал близким другом губернатора Матиаса Бека и директора Питера Стайвесанта. Кроме того, у меня теперь на Антигуа свой личный дом, и в кармане позвякивают деньжата...";
            break;

        case "self_fail":
            sTemp = "Я нашел 'тайную организацию' на Барбадосе, стал вести свою собственную игру, однако в самый ответственный момент все пошло прахом...";
            break;
        }
    ...
    case "Base_afterfight":
        ...
        if (pchar.model == "Sharle_6")
            sTemp = "Смотрю, ты стал капитаном военно-морского флота... Не ожидал, честное слово. Искренне поздравляю!";
