...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Mishelle_prisoner":
			...
			link.l1 = "Ха! Ну надо же! Он рад! Значит, пока ты был на коне и являлся гордостью своего 'Ордена', Шарль был позором семьи, жалким художником, жиголо и придворным шаркуном, так? А теперь, когда тебя упекли за решётку твои же соратники, ты мало того, что вспомнил о своём непутёвом братишке, марателе холстов, так ещё и 'чертовски рад его видеть'!";
			link.l1.go = "Mishelle_prisoner_1";			
		break;
		
		case "Mishelle_prisoner_1":
			dialog.text = "Шарль, ты...";
			link.l1 = "Я ещё не закончил! У тебя хватило наглости сыграть на чувствах нашего батюшки, чтобы помочь самому себе. Так знай же, что я приехал в эту чёртову глушь, где от жары можно сойти с ума, и где москиты буквально заедают насмерть, не ради тебя, а ради нашего бедного отца!";
		...
		case "Mishelle_prisoner_29": // Addon 2016-1 Jason пиратская линейка 1
			...
			link.l2 = "Начать с того, чтобы ещё больше увеличить твои долги? Ты за кого меня держишь, брат? Ясно, помощи от тебя ждать не стоит. Всё сделаю сам!";
		...
		case "trial_15":
			dialog.text = "Ты схватываешь всё буквально на лету, братец. Но довольно слов. Пора применить полученные знания на практике. Жду тебя через три месяца. Думаю, этого времени тебе будет достаточно для знакомства с регионом и заработка небольшого капитала\nНо если ты это время проведёшь, шатаясь по кабакам и борделям, либо в бесцельном хождении между островами, и ничему не научишься - лучше сюда даже и не показывайся. Мы поняли друг друга, Шарль?";
		...
		case "kukulkan_twice": // развилка финалов - есть настоящая маска или нет
			...
			{
				dialog.text = "";
				link.l1 = "Кажется, силы тебя оставляют, великий Кукулькан... Хоть ты и силен, но тело твоё - смертно!";
		...
		case "kukulkan_fail_3":
			dialog.text = "Не весь, "+pchar.name+". Мой артефакт находился на противоположной стороне острова от бухты с 'Санта-Квитерией', в надежно охраняемом святилище. Путь туда ведёт через подводные пещеры, он сложен и неочевиден неискушенному оку смертного. Вот она! Полюбуйся на неё, напоследок...";
		...
		case "kukulkan_win":
			dialog.text = "Бой ещё не окончен, смертный. Ты уже изрядно измотан, а сюда идет подкрепление! Ты всё равно отдашь мне мой артефакт, или я сниму его с твоего трупа - неважно...";
			link.l1 = "...";
			link.l1.go = "exit";
