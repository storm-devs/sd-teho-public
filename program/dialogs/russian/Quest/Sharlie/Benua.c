...
void ProcessDialogEvent()
{
    ...
    case "LH_abbat_1":
        ...
        link.l1 = "Я так понимаю, что ваша миссия зашла в тупик, святой отец? Могу я чем-то помочь, так как бракосочетание в испанской капелле, конечно, авантюра в моем духе, но я твердо намерен провести торжество на Мартинике. Умеренно пышно, и в присутствии солидных свидетелей и почетных гостей.";
        link.l1.go = "LH_abbat_2";
        break;

    case "LH_abbat_2":
        dialog.text = "Жаль, мой мальчик, но весь твой авторитет ничто перед твердолобостью высших иерархов католической церкви, тем более в Испанских колониях. Мы не сошлись в вопросе раздела влияния католических миссий наших стран, и теперь я тут нечто среднее между почетным гостем и почетным же заложником. Испанцы ждут более выгодного предложения с нашей стороны. Я отправил послание в Европу, месяца через два придет ответ, и мы возобновим переговоры. Максимум - через полгода\nДа, Папа Римский и Мазарини пошли навстречу друг другу, но о настоящей оттепели говорить еще рано. Честно сказать, я не уверен, что мы вообще придем здесь к какому-то соглашению. Мне кажется, Палотти просто держит у себя французского аббата как некий аргумент в своей собственной политике. Впрочем, кофе у отца инквизитора отменный - грех жаловаться.";
    ...
    case "LH_abbat_3":
        dialog.text = "Боюсь, тогда тебе придется подыскать другого священника на свою свадьбу, сын мой. Увы, но я здесь надолго.";
        link.l1 = "А что вы скажете, если я разлучу вас и кофе отца инквизитора?";
        link.l1.go = "LH_abbat_4";
        break;

    case "LH_abbat_4":
        dialog.text = "Я бы с радостью принял твою помощь. Подозреваю, что меня выбрали для этой миссии не случайно, чтобы, в случае чего, просто забыть об отце Бенуа. И, хоть Господь и заповедовал терпеть, но я отягощен своим заключением, несмотря на все его... блага. Но, повторюсь - отец Палотти вряд ли снизойдет к твоим просьбам.";
    ...
    case "LH_abbat_5":
        dialog.text = "Это рискованно, мальчик мой. Очень. На выходе меня ждет эскорт, чтобы сопроводить в особняк, и город полон солдат.";
        link.l1 = "Элемент неожиданности, отец Бенуа. Это мой конек - доверьтесь мне и все будет хорошо. В таких делах у меня есть некоторый... опыт.";
    ...
    case "LH_abbat_12":
        dialog.text = "Хорошо, тогда, думаю, мы обойдемся небольшим пожертвованием.";
        link.l1 = "Звучит нестрашно. И сколько составляет это самое пожертвование в золоте?";
        link.l1.go = "LH_abbat_13";
        break;

    case "LH_abbat_13":
        dialog.text = "На хор, торжественную службу, и прочие расходы - сотни полторы, не больше. Плюс обычное пожертвование от молодоженов - и того две сотни дублонов.";
    ...
    case "LH_abbat_14_1":
        dialog.text = "Что насчет пожертвования, сын мой?";
        if (GetCharacterItem(pchar, "gold_dublon") >= 200)
        {
            link.l1 = "Вот, прошу, святой отец.";
            link.l1.go = "LH_abbat_15";
    ...
    case "LH_abbat_15":
        ...
        dialog.text = "Остается еще вопрос, который необходимо решить - кто будет посаженным отцом невесты и свидетельствовать о заключении брака с её стороны?";
        if (CheckAttribute(pchar, "questTemp.Saga.Helena_officer"))
        {
            pchar.questTemp.LongHappy.Pater1 = "Svenson";
            link.l1 = "Ян Свенсон, из Блювельда. Он англичанин, но уважаемый человек и привязан к Элен как к родной дочери, и ее приемная мать Глэдис Мак Артур.";
        }
        else
        {
    ...
    case "LH_abbat_17_1":
        ...
        dialog.text = "Отлично, я разошлю приглашения, но гостям потребуется время, чтобы добраться. Думаю, не позже, чем через месяц, все будет готово, и указанные персоны прибудут в город.";
        link.l1 = "Значит у меня есть время уладить еще пару дел. До встречи, святой отец и пожелайте мне удачи!";
    ...
    case "LH_abbat_19":
        dialog.text = "И вот, этот день настал, мой мальчик! У нас все готово - через пару часов можем начинать. Ты выглядишь бледновато!";
    ...
    case "LH_abbat_33":
        dialog.text = "Есть ли в этом зале кто-то, кто знает причину, по которой эти двое не могут вступить в законный брак? Если так - пусть он выйдет вперед и назовет ее сейчас, или молчит вечно\nТогда, пред ликом Господним, и собравшимися здесь людьми, я объявляю вас мужем и женой! In nomine Patris, et Filii, et Spiritus Sancti. Amen.";
        link.l1 = "Amen.";
    ...
    case "LH_abbat_35":
        ...
        if (sti(pchar.questTemp.LongHappy.Mistake) > 1)
            sTemp = "(шепчет) Шарль, сын мой, просто открывай рот, умоляю - ни звука...";
        else
            sTemp = "";
        dialog.text = "Молодожены, опуститесь на колени, и помолимся вместе. Oratio fidelium. " + sTemp + "";
        link.l1 = "";
    ...
    case "LH_abbat_37":
        dialog.text = "Мои поздравления, сын мой. Твой отец может тобой гордится, и я горжусь. Будьте счастливы и берегите друг друга в наше непростое время.";
        link.l1 = "Спасибо вам святой отец. Это была прекрасная служба и я рад, что именно вы ее провели.";
