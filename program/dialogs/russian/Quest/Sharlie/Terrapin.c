...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "rober_3":
			dialog.text = "Каррамба! Я вспомнил, кто ты! Ты - тот самый парень, который умыл полковника Дойли, отобрав у него целый остров! Ты был замешан в крупных махинациях Голландской Вест-Индской Компании, ты якшаешься с пиратским бароном Западного Мэйна... Тебя зовут... "+GetFullName(pchar)+", верно?";
		...
		case "rober_9":
			dialog.text = "Если всё пойдет как надо, мы с тобой более никогда не встретимся. Надеюсь на это. Бывай!";
			link.l1 = "...";
			link.l1.go = "rober_10";
		break;
		...
		case "tibo_1":
			...
			link.l1 = "Капитан Мартэн ждет вас прямо сейчас в бухте Глаз Рыбы. Но не одного. Он также хочет узреть вместе с вами мисс Молли Джонс. Вы понимаете, о чём я?";
			link.l1.go = "tibo_2";
		break;
		...
		case "tibo_6":
			...
			link.l1 = "Вы не поняли, Анри. Мартэн не будет вас ждать. Ваша единственная надежда - увезти отсюда девку, из-за которой вы оба с Робером вляпались в дерьмо по самые уши. Бегите туда, где вы её прячете, хватайте под белые ручки и тащите на 'Вольтижер'. Не найдя её, ваш дядя ничего не сможет вам предъявить.";
			link.l1.go = "tibo_7";
		break;
		...
		case "tibo_10":
			dialog.text = "Хм. И что?";
			link.l1 = "Капитан Мартэн ждет вас прямо сейчас в бухте Глаз Рыбы. Но не одного. Он также хочет узреть вместе с вами мисс Кэтрин Фокс. Вы понимаете, о чём я?";
			link.l1.go = "tibo_11";
		break;
		...
		case "tibo_15":
			dialog.text = "";
			link.l1 = "Мартэн не будет ждать тебя дольше двух часов - ему дорога собственная голова. Только в знак вашей дружбы он до сих пор торчит в бухте Глаз Рыбы и ждет, пока ты отведёшь ему девушку, а не прячется где-нибудь у голландцев... Однако несчастный Робер даже не подозревает, кто есть Молли Джонс на самом деле. Тоже мне, ценители женских статей! Не смогли отличить леди от простолюдинки!";
			link.l1.go = "tibo_16";
		break;
		
		case "tibo_16":
			dialog.text = "Чего ты хочешь?";
			link.l1 = "Ну наконец-то я слышу разумные слова! Значит так, Тибо: сейчас ты идёшь туда, где прячешь Кэтрин, берёшь её нежно под белые ручки и идёшь вместе с ней в бухту Глаз Рыбы, где стоит 'Вольтижер' Мартэна. Скажешь ему, что планы меняются...";
			link.l1.go = "tibo_17";
		break;
		...
		case "tibo_27":
			...
			link.l1 = "И где же девушка сейчас, раз её не было на 'Вольтижере'?";
			link.l1.go = "tibo_28";
		break;
		...
		case "levasser_room_1":
			...
			link.l1 = "Ты необычайно проницателен, месье Левассер, сеньор де Рене и прочее и прочее. Мое появление здесь не сулит тебе ничего хорошего. Приказом генерал-губернатора Франсуа Ловинье де Пуанси ты смещён с поста и заочно приговорён к смерти! А я – твой судья и палач в одном лице!";
