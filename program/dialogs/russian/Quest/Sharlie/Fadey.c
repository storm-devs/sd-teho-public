...
void ProcessDialogEvent()
{
    ...
    case "guardoftruth_6":
        dialog.text = "Дорогой друг, если уши священника оказываются глухи к воззваниям к совести, то тогда наверняка его руки открыты для золота... И наоборот. Я помогу вам, ибо присутствие вещи, добытой кровавым путем, в нашем приходе я считаю недопустимым. Однако это потребует некоторых расходов." link.l1 = "Я не удивлен. Сколько?";
