...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "norman_us":
			...
			{
				dialog.text = LinkRandPhrase("Что тебе, дружок? Иди своей дорогой, занимайся делами-делишками, а от меня отстань.","Привет-привет, паренёк. Гуляешь? Вот и гуляй себе дальше, и отстань от дядюшки Абрахама. Он тоже гуляет, морским воздухом дышит.","Здравствуй, парнишка. Хочешь поболтать? Но вот ведь незадача: я не в настроении разговаривать. Так что поищи себе другого собеседника. Зайди в таверну, рому выпей...");
			...
			dialog.text = NPCStringReactionRepeat(LinkRandPhrase("Что тебе, дружок? Иди своей дорогой, занимайся делами-делишками, а от меня отстань.","Привет-привет, паренёк. Гуляешь? Вот и гуляй себе дальше, и отстань от дядюшки Абрахама. Он тоже гуляет, морским воздухом дышит.","Здравствуй, парнишка. Хочешь поболтать? Но вот ведь незадача: я не в настроении разговаривать. Так что поищи себе другого собеседника. Зайди в таверну, рому выпей..."), LinkRandPhrase("Морячок, ты туго соображаешь? Я вроде ясно объяснил.","Парень, иди проспись. А то, видать, слышишь плоховато.","Паренёк, ты что - дурачок? Я же вроде доступно всё расписал."), "Приятель, не доводи до греха. Я столько сухопутных крыс на своём веку перерезал, что одной больше, одной меньше - уже неважно.", "Ну всё, ты меня достал. Теперь или доставай свою ржавую саблю, или беги со всех ног. Второе - вернее...", "block", 1, npchar, Dialog.CurrentNode);
		...
		case "norman_fes0_fight":
			dialog.text = "Какой к дьяволу 'Тесоро'?! Ты бы его ещё Бермудами обозвал! Запомни, в честь меня этот остров называется Норман-Айленд. Придётся поучить тебя географии...";
		...
		case "norman_fes4_fight":
			dialog.text = "Её не надо бояться, дружок. Смотри, умирать совсем не страшно...";
		...
		case "norman_fes_again":
			dialog.text = "Всё-всё, приятель, поговорили-договорили, и ладно. Гуляй себе дальше.";
			link.l1 = "Как скажешь...";
			link.l1.go = "exit";
		...
		case "tieyasal_18":
			dialog.text = "А ты? Зачем ты его ищешь? О, понимаю, понимаю: чтобы убить его! Убей его, убей мерзавца! Отомсти за Блейза Шарпа! Блейз был отличным парнем. Я помню его ещё ребенком - весь в Николаса.";
