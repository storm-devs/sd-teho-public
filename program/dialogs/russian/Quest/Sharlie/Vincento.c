...
void ProcessDialogEvent()
{
    ...
    case "First time":
        ...
        if (CheckAttribute(pchar, "questTemp.Guardoftruth.Archy") && pchar.questTemp.Guardoftruth.Archy == "begin")
        {
            ...
            link.l1 = TimeGreeting() + ", Ваше Преосвященство. Есть какие-нибудь новости по нашему делу?" link.l1.go = "guardoftruth_17";
            break;
        }
    ...
    case "utensil_6":
        if (CheckAttribute(pchar, "questTemp.Dolly"))
            sTemp = "Кукулькана?! О, Пресвятая Дева! Опять Кукулькан... ";
        else
            sTemp = "Хм... ";
