...
*/		
		...
		case "On_MaryCeleste_Deck":
		    pchar.quest.givemecat = "true"; // лесник кошка на корабль . символически.
			...
			Link.l1 = "Кошка? Разыщи её и давай к нам на корабль, пусть крыс ловит. И судовой журнал найди, если он вообще был когда-нибудь... В каюте капитана смотрели? Мне нужен судовой журнал."; 
