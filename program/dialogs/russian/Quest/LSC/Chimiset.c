...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "KillChad":
			...
			link.l1 = "Уже стою... Надеюсь, что то, что ты скажешь, будет действительно весомым поводом, чтобы...";
			link.l1.go = "KillChad_1";
			LAi_RemoveCheckMinHP(npchar); //убираем проверяльщик, если еще есть
		break;
		
		case "KillChad_1":
			dialog.text = "Чтобы не убивать меня, верно? Я слышал ваш разговор с Чадом наверху, и не виню тебя - на твоем месте так поступил бы, наверное, каждый. Но ты ошибаешься, если думаешь, что Чад оставит тебя в живых, после того как ты расправишься со мной.";
			link.l1 = "Хм... Интересно, и почему? Пока что я достоверно знаю одно: если я не прикончу тебя, то меня ждет очень печальное будущее.";
			link.l1.go = "KillChad_2";
		break;
		
		case "KillChad_2":
			dialog.text = "У тебя вообще не станет будущего, если ты меня убьешь. Послушай: нарвалы и Чад хотят избавиться от меня, но страх перед моими способностями удерживает их от желания проделать это собственноручно - проклятие падет на род убийцы до двенадцатого колена. Вот они и решили сделать это твоими руками\nЧад прекрасно знал, что ты не ривадос - он взял тебя 'на пушку'. Как только ты меня убьешь - они немедленно расправятся с тобой и преподнесут произошедшее здесь Акуле в выгодном для них свете";
		...
		case "KillChad_3":
			...
			link.l1 = "Знаешь что, колдун, я только что проделал путь через таинственный портал, еле-еле выжил, так что твои проклятия меня не пугают. Довольно я тебя слушал - пора прикончить тебя!";
		...
		case "KillChad_4":
			dialog.text = "Вон там, в углу, стоит сундук. В нем лежит приличное оружие и прочая амуниция. Сундук заперт, но замок там старый и расхлябаный, его можно открыть даже кочергой. Кочерги, правда, тут нет, но есть кое-что получше: у пыточных колодок лежит небольшой металлический ломик\nВо-он там, видишь? Возьми его, вставь острие в замок, нащупай пластину и сильно нажми вниз. Замок сломается, но крышку держать уже не будет. Забери из сундука все, что тебе нужно, и встань у лестницы. Эти негодяи почуят неладное и направятся сюда, но больше чем поодиночке пройти не смогут - лестница слишком узка\nНу и, надеюсь, ты хорошо владеешь шпагой? Потому что я в этом деле тебе не помощник - стар я уже, да и кроме копья никакого оружия в руках и не держал. Если тебе удасться прикончить мерзавцев, я гарантирую тебе защиту ривадос, нашей семьи...";
			link.l1 = "Хорошо. Помолись за меня своим богам - драка предстоит нешуточная. Эти парни наверху выглядели более чем серьезно.";
		...
		case "Chad_die":
			dialog.text = "Отличная работа! Ты и впрямь мастерски владеешь клинком. Я в долгу перед тобой, незнакомец. Скажи, как твое имя?";
		...
		case "Chad_die_2":
			dialog.text = "Это место называется Остров Справедливости, хотя название скорее издевка. Справедливостью здесь и не пахнет. Остров, состоящий из большого количества погибших кораблей. Центральная часть приспособлена для жизни. Внутри кораблей живут люди, которых судьба забросила сюда после кораблекрушений\nРивадос - это клан, группа людей, уже долгие годы живущая вместе. Кроме ривадос на острове есть еще один клан - нарвалы, с которыми у нас извечная вражда, а также пираты Акулы Додсона. Ну, и просто обычные жители. Акула - сейчас он является главой острова, и величает себя адмиралом\nОн прибыл на остров относительно недавно и жесткой рукой установил свою власть. Акула захватил 'Сан-Августин', в трюме которого складируются основные запасы продовольствия на острове, и мы вынуждены его покупать по ценам, которые он сам устанавливает. На этот-то склад, похоже, ты и вломился\nЧад Каппер - это боцман Акулы, а ныне помощник и начальник тюрьмы. Лейтон Декстер - бывший старпом Акулы, тоже не последнее лицо на острове. Эти трое, вместе со своей командой пиратов, имеют серьезное влияние на острове, по сути враждуя с кланами нарвалов и ривадос.";
		...
		case "Chad_die_6":
			...
			AddSimpleRumourCityTip("Так это вы вытащили Чимисета из-за решетки! Очень интересно... Теперь вы друг ривадос, но враг нарвалам. Не знаю, поздравить вас, или посочувствовать...", "LostShipsCity", 5, 1, "LSC", "");
		break;
		...
		case "prisoner_1":
			...
			link.l1 = "По делу. Я пришел от адмирала, Акулы Додсона. Я принес его приказ о твоем освобождении, но при одном условии: ты должен будешь ответить на мои несложные вопросы.";
		...
		case "prisoner_2":
			...
			link.l1 = "Никакого подвоха, мне просто нужна твоя помощь. Скажи, Чимисет: есть ли на острове странный каменный истукан размером с рост человека? В полночь он из каменного превращается в золотой. Только ты не подумай, что я сошел с ума...";
			link.l1.go = "Friend_2";
		break;
		
		case "prisoner_3":
			dialog.text = "У тебя есть еще какие-то вопросы?";
			link.l1 = "Да. Ты не знаешь такого человека - Белый Мальчик? Это имя, или прозвище...";
			link.l1.go = "prisoner_4";
		break;
		
		case "prisoner_4":
			dialog.text = "Белый Мальчик? Конечно, знаю. Так называли в детстве Оле Кристиансена, нашего забавного дурачка, за его белые волосы. Оле уже вырос, и совсем не мальчик, хотя... по уму - совсем ребенок.";
		...
		case "prisoner_5":
			...
			link.l1 = "Отлично! И еще вопрос: ты не встречал здесь человека по имени Натаниэль Хоук? Он должен был появиться недавно, и возможно сильно болен.";
		...
		case "prisoner_7":
			dialog.text = "И это все? Теперь Акула меня выпустит?";
		...
		case "prisoner_9":
			dialog.text = "Не совсем так...(понижая голос) Я вижу, ты не из людей Каппера... Не доверяй Чаду! Это гнусный мерзавец. Не так давно он хладнокровно зарубил палашом безоружного Алана Милроу, главу клана нарвал, который сидел в соседней клетке. Убил без всякой видимой на то причины - просто пришел и расправился\nИ еще: сидя здесь, я слышал обрывки разговоров, из которых у меня сложилась ясная картина: адмирала собираются убить, причем люди из его ближайшего окружения. Передай это Акуле. Также скажи, что подробнее я расскажу только при личной встрече.";
		...
		case "prisoner_11":
			dialog.text = "Ступай поскорее к Акуле и сообщи ему все, что я сказал. Эх, быстрее бы открыли дверь этой клетки...";
			link.l1 = "Да-да, уже иду.";
			link.l1.go = "exit";
		...
		case "Friend":
			dialog.text = "Вот и снова ты, мой дорогой друг. Я еще раз благодарю тебя за помощь, и за то, что ты поверил мне, а не этому подлецу Капперу. И чтобы мои слова обрели еще больший вес, я дарю тебе эти амулеты. Я уверен, что они тебе понадобятся.";
		...
		case "Friend_1":
			...
			link.l1 = "Ты прав, Чимисет. Мне нужна твоя помощь. Но буду последователен. Меня более всего волнует следующее: есть ли на острове странный каменный истукан размером с рост человека? В полночь он из каменного превращается в золотой. Только ты не подумай, что я сошел с ума...";
			link.l1.go = "Friend_2";
		break;
		
		// нода пересечения
		case "Friend_2":
			dialog.text = "Я понял, о чем ты говоришь, мой друг. Я сам видел эту статую бога индейцев. Только золотой она становится не в полночь, а под лучами утреннего солнца... Мы не раз приносили в жертву нечестивцев из клана нарвал, и бог пожирал их. Однако ее уже нет на острове.";
		...
		case "Friend_11":
			dialog.text = "Всегда рад! Если у тебя появятся еще какие-то вопросы - приходи, помогу, чем смогу.";
			link.l1 = "Обязательно! А сейчас мне пора. Еще увидимся!";
		...
		case "freedom":
			dialog.text = "А, вот и мой дорогой друг, которому я обязан свободой, и, возможно, жизнью. Благодарю тебя за то, что помог моим братьям вытащить меня из лап гнусного Каппера. И чтобы мои слова обрели еще больший вес, я дарю тебе эти амулеты. Я уверен, что они тебе понадобятся.";
			link.l1 = "Спасибо! Не ожидал...";
			link.l1.go = "Friend_1";
		break;
		
		case "freedom_1":
			dialog.text = "Ты еще что-то хочешь спросить, белый друг?";
			link.l1 = "Скажи еще, Чимисет: не знаешь ли ты на Острове человека по прозвищу Белый Мальчик?";
			link.l1.go = "Friend_9";
		break;
		...
		case "Chimiset_wait": // стал другом
			if (pchar.questTemp.LSC == "return" && !CheckAttribute(npchar, "quest.return_isl"))
			{
				...
				link.l1 = "Как видишь - я жив и здоров, Чимисет. Духи? Наверное, да - ведь все это произошло благодаря Кукулькану...";
				link.l1.go = "exit";
			...
			link.l9 = "Ничего такого, особенного, Чимисет. Просто зашел проведать тебя.";
			link.l9.go = "exit";
