...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Chimiset":
			...
			link.l1 = "Послушайте, уважаемый, вы ошибаетесь. Я только с час назад вообще появился в этом месте. В трюме этого чертового корабля, за дверью которого меня и схватили. Откуда же я мог знать, что у вас там запретная зона, черт побери?";
			link.l1.go = "Chimiset_1";
		break;
		
		case "Chimiset_1":
			dialog.text = "Да? Неужели? Складно врешь... И откуда же ты прибыл, скажи на милость?";
			link.l1 = "С Мейна... Через эту каменную статую. Как точно - я и сам не понимаю.";
			link.l1.go = "Chimiset_2";
		break;
		
		case "Chimiset_2":
			dialog.text = "Через статую? Ха-ха! Да ты еще и шутник, однако... Ладно, я сам тебе скажу: ты проплыл через пролом в корпусе корабля и намеревался проникнуть на наш склад. Но твоя рожа мне и впрямь незнакома, а я думал, что знаю всех ривадос в лицо...";
			link.l1 = "Каких еще ривадос? Не знаю я никаких ривадос! И знать никогда не знал! Полушайте, я повторяю, я только час назад...";
			link.l1.go = "Chimiset_3";
		break;
		
		case "Chimiset_3":
			dialog.text = "Не ори, я все понимаю с первого раза, не тупой. Да, я уже слышал твой вздор про то, что ты пришел сюда через какую-то статую, и нахожу твою шутку очень забавной. Посмеемся вместе? Ха-ха-ха!.. Ты чего не смеешься, а? Твой розыгрыш удался... ривадос. Но шутки теперь окончены. Я сгною тебя в клетке, обещаю.";
		...
		case "Chimiset_5":
			dialog.text = "Действительно? Хорошо... Тогда докажи это. Внизу, в помещении где мы держим заключенных, в клетке сидит один из ривадос. Он опасный колдун. Убей его, и я не только поверю, что ты не из них, но и прощу тебе твое незаконное вторжение на наш склад\nНу, так что? Готов доказать? Не бойся, колдун не вооружен, у него нет даже иголки... ну, разве что испепелит тебя каким-нибудь заклинанием, вроде того, что перенесло тебя в трюм Сан-Августина...";
		...
		case "Chimiset_6":
			dialog.text = "Довольно разглагольствований! Ты идешь, или нет? Если да, то бери вот это мачете и иди и расправься с колдуном. Если нет - отправишься в клетку до конца дней своих. Что выбираешь?";
		...
		case "Chimiset_7":
			...
			dialog.text = "Молодец. Держи. А теперь ступай и завали этого черномазого. Его клетка отперта. И не вздумай дурить: попробуешь выкинуть какой-нибудь номер - прикончим на месте. Вперед!";
			link.l1 = "О чем речь? Или ты боишься, что я этим куском железа уложу вас всех?";
		...
		case "Chimiset_9":
			dialog.text = "Ты испытываешь мое терпение, недоносок! И оно скоро иссякнет.";
		...
		case "Fightfail_Final":
			...
			link.l1 = "Так ты наконец выпустишь меня из этой чертовой лоханки? Мне срочно нужно встретиться с Акулой.";
			link.l1.go = "Fightfail_Final_1";
		break;
		
		case "Fightfail_Final_1":
			dialog.text = "Встретишься, встретишься... Начнешь с того, что проложишь ему дорожку... в ад!";
			link.l1 = "Что?!";
		...
		case "prisoner":
			...
			link.l1 = "Ты - Чад Каппер, тюремщик, как я понимаю? Меня зовут "+GetFullName(pchar)+", и я пришел от Акулы Додсона. Он дал мне ключ от дверей.";
		...
		case "prisoner_3":
			dialog.text = "Колдуна ривадос? Хм. Очень странно, я удивлен, право...";
		...
		// вариант M
		case "Aeva_attack":
			dialog.text = "...он наверняка уже приложился к бочонку, я уверен. Это его любимый виски, чертов ирландец. Ждать осталось недолго - мышьяка я насыпал столько, что табун лошадей передохнет... А? Черт возьми, что тебе здесь надо? Проваливай!";
		...
		case "Aeva_attack_2":
			dialog.text = "...хорошее получится пойло. Проклятый ирландец давно мечтал об этом виски, так что вылакает пинту сразу же. Так, где мышьяк? Насыпем побольше, чтобы наверняка... А потом наш друг Фацио отнесет бочонок адмиралу, как подарок от нарвалов, ха-ха! Так, любезный Джузеппе? Ты же еще хочешь жить?\nАргх! Смотри-ка, у нас гости! Тебе чего здесь надо, болван? Проваливай, пока цел!";
			link.l1 = "Твой план провалился, Каппер. Я шел по твоим следам, и сразу понял, и где ты, и что ты задумал вместе с Циклопом. Брось мышьяк! Тебе не удастся отравить Акулу.";
