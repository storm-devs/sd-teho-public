...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting_2":
			dialog.text = "Нет, что вы... все в порядке. Вот только почему-то мы вынуждены платить пиратам за наше же продовольствие, которое раньше было бесплатным для всех. А когда кланы устраивают междоусобные побоища на нашей части Острова, мы почему-то должны прятаться по трюмам, чтобы не дай Бог не задело саблей или пулей\nТо есть на нашей территории они делают, что хотят, а мы на их корабли даже носа казать не можем. А в остальном - все хорошо, все хорошо...";
			link.l1 = "Понятно. Ладно, рад знакомству. Еще встретимся!";
			link.l1.go = "exit";
			NextDiag.TempNode = "First time";
		break;
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		...
		case "ansewer_1":
			dialog.text = "Очень. Уже даже и счет потеряла. Наверное, что-то около семнадцати... нет, наверное, восемнадцать... или уже двадцать? А который сейчас год?";
			link.l1 = "Понятно... То есть вы - старожил?";
			link.l1.go = "ansewer_1_1";
		break;
		
		case "ansewer_1_1":
			dialog.text = "Относительно. Я еще помню те времена, когда с нами торговали кубинские буканьеры, а самые отчаянные и ушлые обитатели из нарвалов возили на Большую землю товары из трюмов кораблей и меняли их на провиант. Но что я - тут полно людей, не видевших ничего, кроме этого Острова, поскольку родились здесь. Вот они - даже не старожилы, а коренные жители.";
			link.l1 = "Интересно...";
		...
		case "ansewer_2":
			dialog.text = "Да тут все интересно. Походите, посмотрите сами. Поплавайте вокруг центральной части Острова. Сходите в таверну, в магазин, в церковь. Правда, через неделю интерес пропадет, я вам это обещаю.";
			link.l1 = "Ясно...";
			link.l1.go = "int_quests";
		...
		case "ansewer_3":
			dialog.text = "А как можно относиться к этим разбойникам? Держусь от них подальше, и все. И если от нарвалов Острову еще есть какой-то толк, за счет того, что среди них имеются мастера с золотыми руками, то от этих язычников ривадос ничего, кроме порчи, ожидать не приходится\nОни так и живут по своим африканским обычаям, как и их предки двести лет назад. Разве что огнестрельным оружием пользоваться научились, а так - зверье, а не люди. Говорят, что они даже практикуют ритуальный каннибализм!";
