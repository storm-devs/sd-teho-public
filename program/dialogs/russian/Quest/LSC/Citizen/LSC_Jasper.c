...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting": // первая встреча
			dialog.text = "Я? Я - Джаспер, бывший каторжник. Из-за этого многие смотрят на меня косо. Ну да и черт с ними, я привык...";
			link.l1 = "Мне абсолютно все равно, кем вы были раньше. Главное - кто вы есть сейчас.";
		...
		case "meeting_2":
			dialog.text = "Рад за вас. Смею уверить, что несмотря на мое неудавшееся прошлое, никакой угрозы кошелькам и сундукам обитателей Острова я не представляю. Я просто рад, что могу наконец-то спокойно жить.";
			link.l1 = "Будем знакомы, Джаспер! Еще увидимся!"
			link.l1.go = "exit";
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		case "int_quests":
			...
			{
				link.l3 = "Вы говорили, что на вас смотрят косо. Это все из-за вашего прошлого?";
