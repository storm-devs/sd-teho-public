...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting": // первая встреча
			dialog.text = "Здесь мы все жить в мире, белый брат. Куранай не называть белый брат бледнолицый собака. Не все бледнолицый - собака. А я про многий индеец могу сказать - краснокожий пес.";
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		case "int_quests":
			...
			{
				link.l4 = "Вы мирно здесь живете на острове? Драк, ссор не бывает?";
		...
		case "ansewer_3":
			...
			link.l1 = "Гм. Ну что тут еще добавить...";
			link.l1.go = "int_quests";
