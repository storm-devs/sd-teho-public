...
void ProcessDialogEvent()
{
    ...
    case "meeting_6":
        dialog.text = "Похоже, ты и впрямь из серьезных ребят, " + pchar.name + ". Ладно, мне пора идти. Ещё увидимся! Мне почему-то кажется, что мы с тобой можем подружиться... близко подружиться.";
