...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting_3":
			...
			link.l1 = "Обязательно. Еще увидимся!";
			link.l1.go = "exit";
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
		...
		case "ansewer_1":
			dialog.text = "Я попал сюда вместе с этим надутым индюком Эбботом. Я служил матросом на его корабле. Скажу тебе - такие, как он, никогда не должны ступать на палубу корабля, потому что приносят несчастья. Дернула его нелегкая самому отправиться в плавание\nНадо было дойти всего лишь от Ямайки до Белиза, сущий пустяк. Но словно злой рок преследовал нас: боцман упал за борт, штурман ошибся, вычисляя координаты, да еще эти чертовы испанцы, а потом - шторм. Так и оказались здесь.";
			link.l1 = "Интересно...";
		...
		case "ansewer_2":
			dialog.text = "Черт его знает, приятель. Раньше хотел, а теперь что-то и не очень. Жизнь здесь неплоха, полно рома и вина, разносолы, правда, не всегда в изобилии, но и то еда намного лучше, чем та, которой нас кормили на кораблях, где я служил\nДа и люди здесь есть нормальные, есть с кем выпить и поговорить. Мне здесь нравится. Так что даже и не знаю, что сказать... Пожалуй - нет, не хочу. Раньше я был постоянно голоден и зол, а теперь - посмотри, какое брюхо отъел, ха-ха!";
		...
		case "ansewer_4":
			dialog.text = "А чего здесь думать? Тут мелководье и рифы. Внешнее кольцо состоит сплошь из кораблей, до самого дна. Корабли попадают в шторм, налетают на рифы или прямиком на внешнее кольцо. Так Остров и растет. А вот как внутренние корабли остались на плаву - мне неведомо.";
			link.l1 = "Ясно...";
			link.l1.go = "int_quests";
