...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "meeting": // первая встреча
			dialog.text = "Ха, совсем, как я. Правда, я не моряк, но именно страсть к авантюрам и завела меня сюда, на мою дурную голову. Теперь я, как и все остальные, вынужден тихо гнить на этом корабельном кладбище. Да, мое имя - Адольф Барбье.";
			link.l1 = "Приятно познакомиться, Адольф. Еще увидимся!";
			link.l1.go = "exit";
		...
		//----------------------------------Адольф Барбье----------------------------------------
		case "Adolf":
			dialog.text = "Какого черта ты вламываешься без разрешения в мое жилище?";
			link.l1 = "Что-то ты не очень приветлив к гостям, Адольф. А ведь я пришел к тебе по делу.";
			link.l1.go = "Adolf_1";
		break;
		
		case "Adolf_1":
			dialog.text = "Я не веду никаких дел с посторонними людьми! Убирайся!";
			link.l1 = "Вот как? Значит, с нарвалами ты дела ведешь, а со мной не хочешь? Нехорошо...";
			link.l1.go = "Adolf_2";
		break;
		
		case "Adolf_2":
			dialog.text = "Что ты городишь, клоун? Какие дела с нарвалами? А даже если и веду, то это не твое дело! Даю тебе последний шанс убраться самому, иначе придется вышвырнуть тебя отсюда!";
			link.l1 = "Кишка тонка, 'вышвыриватель'... Значит, так: где штуцер, из которого ты собираешься застрелить адмирала? Сам скажешь, или убеждать придется?";
			link.l1.go = "Adolf_3";
		break;
		
		case "Adolf_3":
			dialog.text = "Что? Какой штуцер? Какой адмирал? Ты часом с катушек не съехал, приятель? Свой штуцер я продал - нет больше его у меня. А кому - не твое собачье дело. И что они будут с ним делать - мне безразлично. А я стрелять ни в кого не собираюсь, ни в адмиралов, ни в генералов. Это тебе понятно, наглец?";
		...
		case "Adolf_4":
			...
			link.l1 = "Ты лжешь, Адольф. Тебя наняли нарвалы, чтобы ты застрелил адмирала. Они дали тебе денег на выкуп штуцера. Они же оплатили покупку этого помещения. Ты лучше меня знаешь, что бушприт, находящийся за этой дверью - единственное место на острове, откуда простреливается кормовая галерея резиденции Акулы.";
			link.l1.go = "Adolf_5";
		break;
		
		case "Adolf_5":
			dialog.text = "Ты ненормальный, псих! Тебя надо срочно изолировать! Я полгода ждал этой каюты, пока Сесил съедет отсюда...";
			link.l1 = "Довольно. Сейчас мы обыщем тебя и твое жилище, найдем штуцер, и наверняка еще какие-нибудь улики. А потом пойдем к Акуле. Он будет рад взглянуть тебе в глаза.";
			link.l1.go = "Adolf_6";
		break;
		
		case "Adolf_6":
			dialog.text = "Ах ты, больной ублюдок! Да я скорее сдохну, чем позволю рехнувшейся мрази копаться в моих вещах!";
			link.l1 = "Тогда придется сделать это без твоего согласия...";
			link.l1.go = "Adolf_7";
		break;
...
//--------------------------------------- блок вопросов и ответов ---------------------------------------------
	case "int_quests":
		...
		case "ansewer_1":
			dialog.text = "Мне как-то попалась рукопись одного мореплавателя - испанца Альворадо, в которой описывался этот Остров, причем довольно точно. Также там было упоминание о нескольких интересных кораблях - 'Сан-Августин', 'Сан-Херонимо' и 'Тартарус'. Все они входили в состав эскадры адмирала де Бетанкура, исчезнувшей больше полувека назад\nЯ раскопал сведения об этой экспедиции. Так вот, на четвертом корабле эскадры, 'Санта Анне', была казна экспедиции - целая куча золотых дублонов! Кроме того, на кораблях имелась золотая руда. Вот я и решил найти этот Остров\nЯ подговорил своего знакомого капитана, и мы отправились на его шхуне на поиски. Чем все кончилось - думаю, понятно. Я нашел и Остров, и корабли де Бетанкура, и даже самого потомка де Бетанкура - он живет у нас на острове, Антонио де Бетанкур его зовут - но уплыть отсюда мне было не суждено\nШхуна разбилась о рифы, компаньон мой погиб, а я с небольшой группой уцелевших добрался сюда. Но что самое обидное - я так и не нашел того, за чем явился - ни казны 'Санта Анны', ни золота с других кораблей.";
		...
		case "ansewer_2":
			dialog.text = "Ривадос - чертовы язычники с дикими и варварскими обычаями. Они прямые потомки негров-рабов, вывезенных из Африки де Бетанкуром. Хоть они многому научились у белых за это время, например, управляться с саблями и мушкетами, как были дикарями, так и остались\nНарвалы - хорошие ребята, толковые, отличные бойцы. Среди них есть просто замечательные мастера. У меня много знакомых среди нарвалов. Может, я когда-нибудь даже вступлю в их клан\nА пираты - черт бы их побрал - явились сюда на нашу голову, захватили склады с продовольствием и теперь продают нам нашу же еду! Каковы негодяи, а? Жаль, никак выгнать их отсюда не получится - придется мириться с их присутствием.";
			link.l1 = "Интересно...";
			link.l1.go = "int_quests";
