...
void ProcessDialogEvent()
{
	...
	// --> Мэри вне LSC
		...
		case "GoldenGirl_3":
			dialog.text = "Передышка нам точно не помешает, да. Но как ты думаешь, дама в британском мундире это высшее общество сильно шокирует? Представляешь эти шепотки по углам? Может, кто даже в обморок упадёт, вот будет веселье, да?";
		...
		case "GoldenGirl_4":
			dialog.text = "Ой, не трудись, да. Скажи прямо - я не того полета птичка, чтобы красоваться перед всякими кружевными уродами. Так, девчушка для развлечений, но на людях с такой показаться стыдно, да? Не гожусь для красивых приёмов, правда ведь, благородный мсье Шарль де Мор?";
		...
		case "GoldenGirl_39":
			dialog.text = "Ладно, ты читай, а я побегу - покажусь нашим, а то мы ещ` сутки тут просидим. Они же тоже волновались, да? И я по ним всем страшно соскучилась! Все же живы? Надеюсь, ты не против, если мы пропустим по чарке внизу? Только смотри, не влипни в очередное безобразие, да!";
