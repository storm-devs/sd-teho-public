...
void ProcessDialogEvent()
{
    ...
    case "drunk_fail":
        ...
        if (sti(pchar.money) >= 500)
        {
            ...
            link.l1 = "Эх, спасибо, Санчо. Ну, что есть - то есть.";
        link.l1.go = "exit";
    ...
    case "rat_1":
        PlaySound("interface\important_item.wav");
        dialog.text = "Она... Точно - она! Именнно такую мне и нарисовал моряк, рассказывавший о ней! Дружище, ты ведь не просто так принёс её мне, правда? Что ты за неё хочешь? Сколько?";
    ...
    case "rat_2":
        dialog.text = "" + pchar.name + ", я отдам тебе за неё самый лучший и дорогой предмет, который у меня есть. Мне он точно ни к чему, а бравому вояке, вроде тебя, будет отличной заменой этому оберегу. Сейчас принесу\nВот, посмотри: уникальная, великолепная миланская кираса штучной работы! Отлично защищает в бою, практически не сковывает движений, легкая, удобная. Таких на Карибах днём с огнём не сыскать, да и в Европе редкость\nЯ нашёл этот доспех в капитанской каюте одного испанского военного корабля несколько лет назад и хранил специально для такого случая, чтобы выменять на что-то ценное. И, похоже, этот момент наступил. Бери себе эту кирасу взамен на Крысиного Бога!";
