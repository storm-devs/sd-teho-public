...
void ProcessDialogEvent()
{
    ...
    case "ansewer_3":
        dialog.text = "У Санчо Карпентеро, владельца таверны на 'Флероне', вы найдете еду, питьё и теплую постель, у Акселя Йоста на 'Эсмеральде' - широкий ассортимент разнообразных товаров. Также поспрашивай на улицах, сын мой - люди часто находят на погибших кораблях внешнего кольца ценные вещи, которые готовы продать.";
        link.l1 = "Спасибо!";
        link.l1.go = "int_quests";
    ...
    case "ansewer_4":
        dialog.text = "Всё в руках Господа нашего, сын мой. Мы веруем в Него и уповаем на Него. До сих пор серьезные потрясения обходили нас стороной - штормы часто бушуют вокруг Острова, но на нём самом как правило тихо и солнечно.";
