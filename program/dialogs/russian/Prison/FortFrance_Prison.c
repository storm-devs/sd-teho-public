...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
        case "quests":
			...
			{
				link.l1 = "Офицер, я тут узнал, что у вас в тюрьме содержится человек по имени Фульк Делюк. Можно ли было бы как-нибудь поспособствовать его освобождению?";
                link.l1.go = "Sharlie";
			}
			if (CheckAttribute(pchar, "questTemp.Sharlie") && pchar.questTemp.Sharlie == "freeskiper")
			{
				link.l1 = "Офицер, я снова по поводу заключенного Фульк Делюка. Я купил право на его долг у ростовщика, и теперь хочу, чтобы этого человека передали мне. Вот его долговые бумаги, ознакомьтесь.";
		...
		//--> Бремя гасконца
		case "Sharlie":
			dialog.text = "А, этот моряк? Он взял в долг у нашего ростовщика приличную сумму денег, не вернул ее вовремя и, более того - стал скрываться. Однако его быстро нашли. С тех пор он под замком, и пока не выплатит всю сумму - будет сидеть за решеткой.";
		...
		case "Sharlie_2":
			dialog.text = "Не знаю. Спросите у ростовщика - он вам подробно все расскажет.";
		...
		case "Sharlie_3":
			...
			dialog.text = "Хм. Всё верно. Вы действительно хотите, чтобы я освободил этого заключенного?";
			link.l1 = "Да. Иначе как он мне вернет мои деньги? У меня есть способ заставить его отработать уплаченную сумму.";
			link.l1.go = "Sharlie_4";
		break;
		
		case "Sharlie_4":
			dialog.text = "Хорошо, месье. Я не вижу причин вам отказывать. Делюка сейчас приведут. Но я считаю своим долгом предупредить вас, что этот лис ускользнет от вас при первой же возможности, так что не питайте на его счет никаких иллюзий.";
			link.l1 = "Я учту это, офицер. А теперь я бы хотел забрать своего должника.";
			link.l1.go = "Sharlie_5";
		break;
		
		case "Sharlie_5":
			dialog.text = "Да, конечно. Сержант! Привести сюда заключенного Фулька Делюка!";
			link.l1 = "...";
