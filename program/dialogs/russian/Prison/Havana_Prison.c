...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    case "Mtraxx_5":
        dialog.text = "Действительно, мне предписано передать дона Лопе Монторо в руки коменданта форта. Видимо, недельки-другой гаупвахты ему всё же не избежать. Если хотите - можете пройти к нему, он ещё здесь.";
