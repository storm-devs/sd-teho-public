...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "trial_2":
			dialog.text = "";
			link.l1 = "Тебя никто ни в чем не заподозрит, может, ещё и табачком разживёшься, а мне точно никто ничего не скажет - сразу поймут, на кого я работаю. Если узнаешь что-нибудь достойное внимания - получишь три тысячи песо. Месяц на свою 'работу' сможешь не выходить.";
			link.l1.go = "trial_3";
		break;
		...
		case "Caleuche_1":
			...
			dialog.text = "Вот...";
			link.l1 = "Так-так... Занятная вещица, согласен. Явно вывезена из индейских поселений. Хорошо, я забираю её. Вот твоё серебро.";
			link.l1.go = "Caleuche_2";
		break;
		
		case "Caleuche_2":
			AddMoneyToCharacter(pchar, -2000);
			dialog.text = "Спасибо, милостивый господин! Надеюсь, эта вещь принесёт вам удачу! Да хранит вас Господь!";
