...
string DonationType()
{
    ...
    {
    case 0:
        sText = "Я собираю деньги на постройку " + LinkRandPhrase("часовни", "богадельни", "лазарета") + ". Местные жители подают мало и неохотно, и я вынужден обращаться к состоятельным людям вроде вас." break;
    case 1:
        sText = "Я собираю пожертвования для нашей церкви. Не у каждого моряка есть время посетить храм Божий, но каждый должен стараться спасти свою грешную душу." break;
    case 2:
        sText = "Я собираю деньги на покупку лекарств для нашего приюта сирых и немощных. Пожертвуйте, ибо каждый из нас под старость может оказаться там." break;
    case 3:
        sText = "Я собираю средства на новую утварь для нашей церкви - привезённая из Европы уже фактически пришла в негодность. Забота о церкви - долг каждого истинного христианина." break;
    case 4:
        sText = "Я собираю деньги на ремонт нашей церкви - кровля протекает даже в небольшой дождь, и церковные скамьи нуждаются в починке. Забота о церкви - долг каждого истинного христианина." break;
    case 5:
        sText = "Я собираю денежные средства, чтобы оплатить труд хорошего живописца, который сможет расписать стены нашей церкви замечательными картинами на библейские сюжеты. Помогать церкви в сим благом деле - долг каждого истинного христианина." break;
    case 6:
        sText = "Я собираю деньги на новый иконостас для нашей церкви. Приход у нас бедный, и дело продвигается медленно. Я надеюсь на вашу помощь." break;
    case 7:
        sText = "В нашем лазарете сейчас много раненых моряков с военного корабля. Им требуются лекарства и перевязочный материал. Помогите им, ибо вы, как никто другой, должны понимать страдания простых матросов." break;
    case 8:
        sText = "Я пытаюсь собрать деньги на пропитание и одежду для беднейших жителей нашей колонии, у которых одна надежда - на святую церковь. Помогите им." break;
    case 9:
        sText = "Я намереваюсь отбыть с миссионерской целью в глубь острова к коренным жителям, нести свет заблудшим душам, и собираю средства на организацию экспедиции. Помогите же и вы благому делу!" break;
    }
    return sText;
}