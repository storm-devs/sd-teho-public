    ...
    case "lombard_4":
        if (CheckAttribute(pchar, "GenQuest.Noblelombard.Regard"))
        {
            ...
            if (pchar.GenQuest.Noblelombard == "full")
                link.l1 = "Да, был. Я оплатил проценты за три месяца и стоимость вашего раритета. Можете идти и забирать его.";
            if (pchar.GenQuest.Noblelombard == "maxpercent")
                link.l1 = "Да, был. Я оплатил проценты за истекшие три месяца, и авансом за следующие три. Так что можете спокойно ждать денег. Главное - не позже, чем через три месяца, оплатить сумму основного долга.";
            if (pchar.GenQuest.Noblelombard == "minpercent")
                link.l1 = "Да, был. Я оплатил проценты за истекшие три месяца. Ростовщик согласен подождать ещё три, пока вы соберёте нужную сумму.";
...
string DonationText()
{
    ...
    {
    case 0:
        sText = "Я вчера проигрался в карты, и на покрытие долга не хватает сущей безделицы. Не сможете меня выручить?" break;
    case 1:
        sText = "Я вчера здорово повеселился с одной... девкой, а теперь она меня пытается шантажировать. Мне нужно заплатить ей, ну а потом я уже с ней разберусь... Не могли бы вы мне помочь небольшой суммой?" break;
    case 2:
        sText = "Я тут на днях проткнул одного невежу шпагой, так теперь комендант требует мзду, чтобы замять дело. Мне не хватает совсем немного. Может, выручите?" break;
    case 3:
        sText = "Я имел неосторожность проиграть в споре, а на уплату долга чести у меня банально не хватает нескольких жалких монет. Не поможете?" break;
    case 4:
        sText = "Один негодяй узнал о моей причастности к пикантной истории с одной дамой... В общем, мне не хватает буквально несколько золотых, чтобы купить его молчание." break;
    case 5:
        sText = "Один негодяй выкрал из моего дома важные бумаги и требует за них кругленькую сумму. Я собрал всё, что нужно, но не хватает сущего пустяка. Выручите?" break;
    }
    return sText;
}
...
void LombardText()
{
    ...
    case 0:
        ...
        break;
    case 1:
        pchar.GenQuest.Noblelombard.Item = "изумрудное колье моей сестры работы парижского ювелира";
