...
void ProcessDialogEvent()
{
    ...
    case "First time":
        ...
        {
            dialog.text = LinkRandPhrase("Милок, позолоти ручку. Всю правду тебе расскажу.", "Эй, морячок, не спеши! Хочешь узнать всю правду?", "Угости табачком, соколик, и парой серебряных монет, а я загляну в твоё будущее.");
        ...
        //-------------------------------------------------гадание-------------------------------------------------
    case "guess":
        dialog.text = "Конечно, милок. Дай несколько монет и покажи свою правую ладонь - поведаю о том, что ждёт тебя впереди, без обману!";
    ...
    case "guess_1":
        dialog.text = "А, милок, это сколько позволит тебе твой кошель и твоё желание.";
        link.l1 = "100 песо.";
    ...
    case "get_poison_1":
        ...
        if (drand(10) == 3)
        {
            dialog.text = LinkRandPhrase("Ой не знаю, красавец! Давеча один вот тоже просил крыс примучить, а потом кто-то солдат в форте потравил. Нас две недели на допрос таскали. Чуть из города не погнали, пока не нашли того душегуба. Лазутчиком вражеским оказался.",
                                         ...
                                         "Сказывали мне, что в прошлом месяце кто-то отравил в таверне заезжего купца и обобрал до нитки. А купец тот ещё долго мучился пока представился, весь пеной изошёл и синий стал, как баклажан. Не твоих ли рук дело, яхонтовый мой?");
    ...
    case "get_poison_4":
        ...
        // --> Мангароса
    case "mangarosa":
        dialog.text = LinkRandPhrase("Показывай, соколик, что там у тебя за травка... Хм... пожалуй, я куплю её у тебя. Три сотни песо тебя устроит?", "Покажи мне её, дружок... Хе... ну, две с половиной сотни я тебе за неё, пожалуй, заплачу.", "Давай посмотрим... О! Интересный экземпляр! Две сотни серебряных монет! По рукам?") "";
    ...
    case "mangarosa_1":
        dialog.text = "Хорошо-хорошо, красавчик. Вижу, что тебе известно кое-что об этом растении. Пятьдесят дублонов. Давай её сюда.";
    ...
    case "mangarosa_trade":
        ...
        PlaySound("interface\important_item.wav");
        dialog.text = "Получи свои монеты, соколик. Если найдешь ещё мангаросы - приноси нам. Правда, покупаем мы только по одному стеблю - большие суммы в дублонах с собой не носим. Уж больно любит к нам цепляться городская стража.";
    ...
    case "mangarosa_trade1":
        dialog.text = "Спрашиваешь, соколик! Конечно! Давай её мне.";
        link.l1 = "Давай пятьдесят дублонов.";
        link.l1.go = "mangarosa_trade1_1";
        link.l2 = "Ой! Кажется, я её или потерял, или забыл на корабле. Какая досада! Извини...";
        link.l2.go = "exit";
        npchar.quest.mangarosa = "true";
        break;
    ...
    case "mangarosa_7":
        dialog.text = "Ну ты же моряк, соколик, а я нет. Поищи хорошенько там, где я сказала. Её дом совсем близко от берега. Там ещё рядом есть какая-то бухта - моряки должны её знать.";
...
string GuessText()
{
    ...
    {
    case 0:
        sText = "повезёт тебе соколик, завтра непременно в карты повезёт!" break;
    case 1:
        sText = "в загаданном деле тебя ожидает удача, капитан!" break;
    case 2:
        sText = "в открытом море неудача таится, именно тебя ждёт, подожди три дня!" break;
    case 3:
        sText = "вижу, необходимо тебе искать помощи близких людей, один в следующем бою не выжевешь!" break;
    case 4:
        sText = "сходи, поставь свечку в церкви, проклял тебя недруг. Без божьей помощи не справишься!" break;
    case 5:
        sText = "потеряешь вскоре многое, но всё-таки отчаиваться не надо – надейся на собственные силы, ищи помощи друзей..." break;
    case 6:
        sText = "потеря тебя ожидает, в море, но вижу я - сумеете, капитан, если и не добиться желаемого, то возместить потраченные силы и средства при других обстоятельствах." break;
    case 7:
        sText = "ты вступил в полосу неудач, капитан! Сходи в бордель, развейся." break;
    case 8:
        sText = "твоё желание хоть и будет исполнено, однако же ничего хорошего ждать от этого не придётся: то, чего ты так страстно хотел, кэп, принесёт одни неприятности, и лучше отказаться от задуманного." break;
    case 9:
        sText = "вижу на челе твоём отблеск абсолютной удачи: сбудется даже больше того, на что рассчитывал, соколик!" break;
    case 10:
        sText = "тебе необходимо заново оценить своё желание и решить, необходимо ли его исполнение: судьба даёт шанс подумать." break;
    case 11:
        sText = "это редкое везение – не так часто у нас есть шанс передумать. Просто отдохни денёк, ясноглазый, подумай о бренном. Не спеши на смерть!" break;
    case 12:
        sText = "хотя все затраченные вами усилия и не принесут ожидаемого результата, отчаиваться не стоит – в самый неожиданный момент тебя ждёт удача, не пропусти её!" break;
    case 13:
        sText = "твой конкретный вопрос не будет решён положительно, но ты упрям, всё равно получишь своё, но, может быть, вовсе не оттуда, откуда ожидал." break;
    case 14:
        sText = "лучше забудь о том деле, которым занят – удачи тебе в нём никогда не будет, а если продолжишь настаивать, то, возможно, пострадают или даже погибнут твои спутники." break;
    case 15:
        sText = "впереди тебя ожидает событие, капитан, которое настолько круто переменит твою жизнь, что всё сейчас происходящее не будет иметь никакого значения!" break;
    case 16:
        sText = "на пути к исполнению твоего желания тебя подстерегает опасность, и тебе очень повезёт, если сумеешь добиться того, чего хотел, ничего не потеряв, капитан. Лучше, пока не поздно, свернуть с пути и забыть мечту недостижимую. Хотя, если прямо сейчас в кости или карты проиграть, то судьбу можно обмануть..." break;
    case 17:
        sText = "вижу силу в тебе могучую, как скала, и свет яркий, как звёзды, что людей за собой поведёт. Хороший знак и добрая весть тебя ждут." break;
    case 18:
        sText = "знак недобрый на твоем пути встанет, опасайся дурного глаза, и держи поближе верных людей." break;
    case 19:
        sText = "счастливый случай дожидается тебя чуть не за спиной. Ищи то, что само идёт в руки, и не гонись за несбыточным." break;
    }
    return sText;
}
