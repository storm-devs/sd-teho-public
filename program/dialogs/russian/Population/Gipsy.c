...
string GuessText()
{
	...
	switch (drand(19))
	{
		...
		case 8: sText = "твоё желание хоть и будет исполнено, однако же ничего хорошего ждать от этого не придётся: то, чего ты так страстно хотел, кэп, принесёт одни неприятности, и лучше отказаться от задуманного." break;
		...
		case 13: sText = "твой конкретный вопрос не будет решён положительно, но ты упрям, всё равно получишь своё, но, может быть, вовсе не оттуда, откуда ожидал." break;
		case 14: sText = "лучше забудь о том деле, которым занят – удачи тебе в нём никогда не будет, а если продолжишь настаивать, то, возможно, пострадают или даже погибнут твои спутники." break;
		...
		case 16: sText = "на пути к исполнению твоего желания тебя подстерегает опасность, и тебе очень повезёт, если сумеешь добиться того, чего хотел, ничего не потеряв, капитан. Лучше, пока не поздно, свернуть с пути и забыть мечту недостижимую. Хотя, если прямо сейчас в кости или карты проиграть, то судьбу можно обмануть..." break;
