...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    case "LH_letter":
        ...
        {
            link.l1 = "Я зайду чуть попозже, кажется, я забыл кошелек в таверне.";
            link.l1.go = "exit";
        }
        break;
