...
void ProcessDialogEvent()
{
    ...
    case "junior_1":
        dialog.text = "Слушай внимательно. Ты должен встретиться с его доверенным лицом по кличке Валет. Он капитан полакра 'Марлин', больше я о нем ничего не знаю. Ты найдёшь его в Капстервиле. Пароль - 'охота уже началась'. От него ты узнаешь, что делать дальше. Мне ты ничего не должен. Я просто решил тебе помочь. Если удача не отвернется от тебя, мы ещё встретимся.";
    ...
    case "terrax_2":
        dialog.text = "Чёрт побери! Чего ты хочешь?";
    ...
    case "terrax_4":
        if (!CheckAttribute(pchar, "questTemp.Saga.DodsonDie"))
            sTemp = "И Стивен Додсон на нашей стороне. ";
        else
            sTemp = "";
    ...
    case "terrax_8":
        ...
        {
            link.l1 = "Я тебе напомню кое-что. Не так давно ты хотел убить меня и подослал свою шавку, Игнасио Марко. Это я кокнул его. Это я сломал твои планы по захвату испанского галеона с золотом из Гаваны. Это я отправил с Синт-Маартена в лапы испанцев твого дружка Джимми Джокера, а также Бродягу и Упыря. Я - Чарли Принц! Теперь мы в расчёте, Жак, но будь любезнее со мной при последующих встречах. Ведь мы не раз с тобой ещё увидимся, я думаю. Не забывай, что за мной - все пиратские бароны, включая будущего главу Братства. А теперь - бывай, Барбазон...";
            link.l1.go = "terrax_9";
        }
        else
        {
