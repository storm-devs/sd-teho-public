...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "goldengirl_3":
			...
			link.l1 = "Прошу прощения, Ваша Светлость. Наверное, это от облегчения - я, признаться, подустал в последнее время от всех этих батальных полотен и был уверен, что у вас тут еще одно на примете. Что ж, давайте про бордель. Мадам Бото, говорите? Не припоминаю.";
		...
		case "goldengirl_6":
			dialog.text = "Вы словно не слушаете! Джулианна Бото, она, скажем так, коллекционирует в своем салоне различных ярких и знаменитых людей. Они придают её приёмам свежесть и интерес. Ну а вы личность весьма и весьма известная, и маркиза долгое время ждала случая заполучить такого гостя. И вот - моя оплошность дала ей эту возможность. Поймите, я не переживу, если она опять откажется меня видеть. А расплатой за провал будет именно это!";
