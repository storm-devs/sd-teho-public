...
void ProcessDialogEvent()
{
    ...
    case "KnowAboutPrisoner":
        ...
        case "0":
            ...
            break;
        case "1":
            sTemp = "Он обвиняется в пиратстве.";
            break;
        case "2":
            sTemp = "За бандитизм и разбойное нападение.";
            break;
        case "3":
            sTemp = "Он попался на воровстве.";
            break;
        case "4":
            sTemp = "За мелкую кражу.";
            break;
        case "5":
            sTemp = "За шулерство.";
            break;
        case "6":
            sTemp = "За бродяжничество и попрошайничество.";
            break;
        }
        dialog.text = sTemp;
