...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	case "rumours_habitue":
        ...
        {
			dialog.text = "(поет) Я бла-агода-арен виски за свой багро-овый нос, и по-о его-о совету пальто в закла-ад отнёс... Эх, наливай, моря"+ GetSexPhrase("к","чка") +"! Я только вчера из рейса, поэтому ещё немного не в себе.";
		...
		case "rumours_tavern_yes":
			if (CheckAttribute(pchar, "questTemp.Saga.BarbTemptation"))
			{
				...
				if (bOk && npchar.location == "Marigo_tavern" && !CheckAttribute(npchar, "quest.barbtemptation"))
				{
					...
					Dialog.Text =  "Недавно наш патруль потопил бригантину некого французского контрабандиста Мореля, а самого его взял в плен. Теперь этот Морель сидит в каземате и дожидается суда. Комендант уверен, что на корабле был не весь груз контрабанды, и пытается вызнать это. А как только узнает - тут и конец французишке...";
