...
//*************************** Открывание двери ***************************
	...
	// ------------------------------------------- хронометр Алекса ----------------------------------------------// Addon-2016 Jason замена дублонов на песо везде
		...
		case "clock_begin_3":
			...
			link.l1 = "Я очень сожалею, мастер, но я сейчас занят не меньше, чем "+sTotalTemp+". Боюсь, что сбор материалов может занять целую вечность. Так что лучше вы попросите кого-нибудь ещё.";
		...
		case "clock_5":
			dialog.text = "Ах, простите, кажется, я увлекся своими фантазиями. Старость - не радость, молодой человек. Извините... Но неважно. Важно то, что мой ящик с вашим подарком лежит сейчас в сундуке в подземелье, а по нему уже который день шляются какие-то тёмные личности. Они не из наших, не с Исла Тесоро\nХодят, вынюхивают, ковыряются в сундуках. Кладокопатели, которым кто-то сообщил, что здесь можно поживиться. Сюда ко мне они залезть навряд ли рискнут, но и я туда сунуться боюсь, понимаете? У них такие рожи, что...";
