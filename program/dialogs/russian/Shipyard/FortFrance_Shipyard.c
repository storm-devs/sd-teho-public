...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "FMQM_6":
			dialog.text = "Не переживайте. Вы же не понесёте ее в магазин или контрабандистам. После операции возвращаетесь в Сен-Пьер и ставите своё судно ко мне в доки на ремонт, вечером. По темноте, дабы не привлекать внимание плотников, двое моих верных людей перенесут всю смолу с вашего корабля в укромное место на верфи. Никто ничего не заподозрит.";
