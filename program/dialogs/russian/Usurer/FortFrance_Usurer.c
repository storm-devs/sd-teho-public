...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Sharlie":
			...
			link.l1 = "Мне нужен этот человек. Причем на свободе, а не за решёткой. А поскольку в тюрьме мне сообщили, что пока долг не будет возвращен вам, то его не выпустят, я заинтересован в погашении этого долга.";
