...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "FMQG_1":
			...
			link.l1 = "Хорошо. Месье Пинетт зафрахтовал мое судно для того, чтобы я доставил его и двух его друзей с Гваделупы на испанский Мэйн, а именно - в залив Москитос, что у Порто-Белло. Я выполнил его заказ и перевёз Бертрана и его товарищей в указанное место, где они покинули мой корабль и ушли в джунгли.";
			link.l1.go = "FMQG_2";
		break;
		...
		case "FMQG_3":
			...
			link.l1 = "Да. Это все, что я знаю о Бертране Пинетте. Что-нибудь ещё, месье, или я могу откланяться?";
			link.l1.go = "FMQG_4";
		break;
