...
void ProcessDialogEvent()
{
    ...
    case "First time":
        ...
        if (npchar.quest.meeting == "0")
        {
            ...
            link.l1 = "Здравствуй, " + npchar.name + "! Моё имя - " + GetFullName(pchar) + ", я капитан корабля. Гулял по этой чудесной бухте, решил заглянуть, посмотреть - кто тут живет...";
    ...
    case "Lightman_talk":
        ...
        link.l4.go = "quests";
        link.l9 = "Просто на огонёк заглянул...";
        link.l9.go = "exit";
        NextDiag.TempNode = "First time";
        break;
    ...
    case "exit_artefact":
        if (CheckAttribute(npchar, "artefact"))
            dialog.text = "Ну, как знаете. Надумаете - обращайтесь.";
        else
            dialog.text = "Будете смотреть, что у меня есть сегодня в продаже, капитан? Если ничего достойного не найдёте - заходите ещё, почаще, может, что интересующее вас и появится.";
