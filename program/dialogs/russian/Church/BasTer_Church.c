...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "guardoftruth_1":
			dialog.text = "Все мы грешны, сын мой, и все равны перед Богом... но убийство священнослужителя - серьёзное обвинение. Ты можешь чем-нибудь доказать свои слова? И из какого прихода был украден этот крест?";
			link.l1 = "Моё слово разве не может являться доказательством? А этот крест был похищен из прихода Сантьяго и должен быть возвращен назад.";
