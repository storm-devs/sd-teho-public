void ProcessDialogEvent()
{
    ...
    case "Exit_fight":
        ...
        AddSimpleRumourCity("Слыхали? Недавно в бухте патруль облаву на контрабандистов устроил. И что бы вы думали? Капитану, который местным скупщикам товар отгружал, удалось уйти! " +
                                "Лихие ребята у него в команде оказались - весь патрульный отряд положили. И наши местные, как в воду канули. Так в бухте ничего, кроме трупов, и не нашли - ни товара, ни тайника, ни самих контрабандистов. Вот же как у этих проходимцев промысел-то организован!",
