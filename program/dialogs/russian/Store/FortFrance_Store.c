...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				Link.l1 = "Это опять я, месье. Я пришел за своей наградой.";
			...
			{
				link.l1 = "Посмотрите на эти серьги, месье. Я нашел их на теле убитого бандита в джунглях. Это явно работа хорошего ювелира, которого в этой глуши и быть не могло. Можете что-нибудь сказать об этих серьгах?";
		...
		case "Sharlie_storehelper":
			dialog.text = "Поручение? Хм. Пожалуй, у меня действительно будет для вас работа такого рода, как вы хотите. У меня пропал помощник, работавший на складе. Уже как неделю его нет, и это, черт возьми, крайне неприятно, потому что мне приходится делать еще и его работу, а я совершенно не успеваю\nЯ вас прошу, разыщите этого болвана и выясните, какого лешего он забросил работу, а еще лучше - приведите его ко мне. За помощь я заплачу вам тысячу песо.";
		...
		case "Sharlie_storehelper_2":
			...
			link.l1 = "Я нашел его в Ле Франсуа. Он больше не будет работать на вас. Он так и сказал. А также добавил еще много чего в ваш адрес... вам интересно послушать, что именно?";
		...
		case "Sharlie_storehelper_5":
			...
			dialog.text = "Да пожалуйста, держите ваши деньги. Ха! Я мало плачу! Конечно, теперь мне понятно, почему я никого не могу нанять - этот негодяй распустил по городу гнусные слухи обо мне. Но что же мне делать? Я один не справляюсь\nМне нужно не спать полночи, чтобы сосчитать весь товар, и еще постоянно смотреть надо, чтобы никто ничего не стянул, вместо того, чтобы торговать! После прошлой погрузки я недосчитался пяти бочонков рома - я уверен, что грузчики 'по ошибке' прихватили их...";
		...
		case "Sharlie_storehelper_8":
			dialog.text = "Это будет зависеть от того, какого работника вы наймете. Чем более умелым он окажется - тем больше я заплачу за вашу услугу. Так будет справедливо, согласитесь.";
