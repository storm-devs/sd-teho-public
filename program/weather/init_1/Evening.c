int Whr_InitEvening(int n)
{
    ...
    Weathers[n].Sun.AzimuthAngle = Degree2Radian(286.0);
    Weathers[n].Sun.HeightAngle = 15.0;
    ...
    Weathers[n].Sun.AzimuthAngle = Degree2Radian(292.0);
    //Weathers[n].Sun.AzimuthAngle = Degree2Radian(247.0);
    Weathers[n].Sun.HeightAngle = 2.20;
    Weathers[n].Sun.Glow.Enable = true;
    Weathers[n].Sun.Glow.Dist = 3500.0;
    ...
    Weathers[n].Sun.AzimuthAngle = Degree2Radian(299.0);
    Weathers[n].Sun.HeightAngle = -10.00;
    ...
    Weathers[n].Sun.AzimuthAngle = Degree2Radian(337.0);
    Weathers[n].Sun.HeightAngle = -10.0; //0.1;
    Weathers[n].Sun.Glow.Enable = true;
    Weathers[n].Sun.Glow.Dist = 3500.0;
    Weathers[n].Sun.Glow.Size = 1250.0;
    Weathers[n].Sun.Glow.RotateSpeed = 1.0;
