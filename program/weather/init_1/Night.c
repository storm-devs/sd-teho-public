...
int Whr_InitNight(int n)
{
    ...
    Weathers[n].Sun.HeightAngle = -0.10; //0.30;
    ...
    Weathers[n].Sun.AzimuthAngle = Degree2Radian(99.0);
    ...
    Weathers[n].Sun.AzimuthAngle = Degree2Radian(133.0);
    Weathers[n].Sun.HeightAngle = 0.42; //0.20;
    Weathers[n].Sun.Moon = true;
    Weathers[n].Sun.Glow.Enable = true;
    Weathers[n].Sun.Glow.Dist = 3500.0;
    Weathers[n].Sun.Glow.Size = 110.0;
    ...
    Weathers[n].Sun.HeightAngle = 0.35; //0.50;
    Weathers[n].Sun.Moon = true;
    Weathers[n].Sun.Glow.Enable = true;
    Weathers[n].Sun.Glow.Dist = 3500.0;
    Weathers[n].Sun.Glow.Size = 110.0;
    ...
    Weathers[n].Sea2.FoamTexDisturb = 0.1;
    ...
    Weathers[n].Sun.AzimuthAngle = Degree2Radian(170.0);
    Weathers[n].Sun.HeightAngle = 0.20; //0.28;
    Weathers[n].Sun.Moon = true;
    Weathers[n].Sun.Glow.Enable = true;
    Weathers[n].Sun.Glow.Dist = 3500.0;
    Weathers[n].Sun.Glow.Size = 110.0;
    ...
    Weathers[n].Sun.AzimuthAngle = Degree2Radian(188.0);
    Weathers[n].Sun.HeightAngle = -10.0;
    Weathers[n].Sun.Moon = true;
    Weathers[n].Sun.Glow.Enable = true;
    Weathers[n].Sun.Glow.Dist = 3500.0;
    Weathers[n].Sun.Glow.Size = 110.0;
