...
void WhrFillSunGlowData(int nw1, int nw2)
{
    ...
    aref aSun1;
    makearef(aSun1, Weathers[nw1].Sun);
    aref aGlow1;
    makearef(aGlow1, aSun1.Glow);
    aref aFlare1;
    makearef(aFlare1, aSun1.Flare);
    aref aOverflow1;
    makearef(aOverflow1, aSun1.Overflow);
    aref aReflection1;
    makearef(aReflection1, aSun1.Reflection);
    ...
    if (nw2 >= 0)
    {
        ...
        if (stf(Environment.date.day) > 0 && stf(Environment.date.day) < 4)
            SunGlow.Glow.MoonTexture = "weather\sun\glow\moon00.tga.tx";
        if (stf(Environment.date.day) > 3 && stf(Environment.date.day) < 8)
            SunGlow.Glow.MoonTexture = "weather\sun\glow\moon01.tga.tx";
        if (stf(Environment.date.day) > 7 && stf(Environment.date.day) < 12)
            SunGlow.Glow.MoonTexture = "weather\sun\glow\moon02.tga.tx";
        if (stf(Environment.date.day) > 11 && stf(Environment.date.day) < 16)
            SunGlow.Glow.MoonTexture = "weather\sun\glow\moon03.tga.tx";
        if (stf(Environment.date.day) > 15 && stf(Environment.date.day) < 20)
            SunGlow.Glow.MoonTexture = "weather\sun\glow\moon04.tga.tx";
        if (stf(Environment.date.day) > 19 && stf(Environment.date.day) < 24)
            SunGlow.Glow.MoonTexture = "weather\sun\glow\moon05.tga.tx";
        if (stf(Environment.date.day) > 23 && stf(Environment.date.day) < 28)
            SunGlow.Glow.MoonTexture = "weather\sun\glow\moon06.tga.tx";
        if (stf(Environment.date.day) > 27 && stf(Environment.date.day) < 32)
            SunGlow.Glow.MoonTexture = "weather\sun\glow\moon07.tga.tx";
