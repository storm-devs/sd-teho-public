...
void FillPriceListTown(string _tabName)
{
    ...
    GameInterface.(_tabName).hr.td1.scale = 0.77 GameInterface.(_tabName).hr.td2.str = "Город";
...
void FillPriceListTownSorted(string _tabName)
{
    ...
    i = 0;
    OurColonies[i] = "Havana";
    i = i + 1;
    OurColonies[i] = "Santiago";
    i = i + 1;
    OurColonies[i] = "PuertoPrincipe";
    i = i + 1;
    OurColonies[i] = "PortRoyal";
    i = i + 1;
    OurColonies[i] = "FortOrange";
    i = i + 1;
    OurColonies[i] = "Tortuga";
    i = i + 1;
    OurColonies[i] = "PortPax";
    i = i + 1;
    OurColonies[i] = "SantoDomingo";
    i = i + 1;
    OurColonies[i] = "LaVega";
    i = i + 1;
    OurColonies[i] = "Terks";
    i = i + 1;
    OurColonies[i] = "SanJuan";
    i = i + 1;
    OurColonies[i] = "Pirates";
    i = i + 1;
    OurColonies[i] = "Marigo";
    i = i + 1;
    OurColonies[i] = "Charles";
    i = i + 1;
    OurColonies[i] = "SentJons";
    i = i + 1;
    OurColonies[i] = "BasTer";
    i = i + 1;
    OurColonies[i] = "Dominica";
    i = i + 1;
    OurColonies[i] = "FortFrance";
    i = i + 1;
    OurColonies[i] = "LeFransua";
    i = i + 1;
    OurColonies[i] = "Bridgetown";
    i = i + 1;
    OurColonies[i] = "Villemstad";
    i = i + 1;
    OurColonies[i] = "PortSpein";
    i = i + 1;
    OurColonies[i] = "Cumana";
    i = i + 1;
    OurColonies[i] = "Caracas";
    i = i + 1;
    OurColonies[i] = "Maracaibo";
    i = i + 1;
    OurColonies[i] = "Cartahena";
    i = i + 1;
    OurColonies[i] = "PortoBello";
    i = i + 1;
    OurColonies[i] = "Panama";
    i = i + 1;
    OurColonies[i] = "Pearl";
    i = i + 1;
    OurColonies[i] = "SantaCatalina";
    i = i + 1; // Blueweld
    OurColonies[i] = "Beliz";
    i = i + 1;
    OurColonies[i] = "Caiman";
    i = i + 1;

    OurColonies[i] = "Tenotchitlan";
    i = i + 1;
    OurColonies[i] = "Minentown";
    i = i + 1;
    OurColonies[i] = "LostShipsCity";
    i = i + 1;
    OurColonies[i] = "KhaelRoa";
    i = i + 1;
    OurColonies[i] = "Ksochitam";
    i = i + 1;
    OurColonies[i] = "RockIsland";
    i = i + 1;
    OurColonies[i] = "SantaQuiteria";
    i = i + 1;
    OurColonies[i] = "IslaDeVieques";
    i = i + 1;
    OurColonies[i] = "Is";
    i = i + 1;
...
void FillPriceList(string _tabName, string attr1)
{
    ...
    if (attr1 != "")
    {
        ...
        for (i = 0; i < GOODS_QUANTITY; i++)
        {
            row = "tr" + n;
            sGoods = "Gidx" + i;
            if (sti(nulChr.PriceList.(attr1).(sGoods).TradeType) == T_TYPE_CANNONS && !bBettaTestMode)
                continue; // не пушки
