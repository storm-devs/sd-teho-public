...
void UpdateInterface()
{
    ...
    if (!isSteamOverlayEnabled) // оверлей закрыт
    {
        ...
        if (DLCAppID > 0)
        { // есть обновления
            arMenu.l6.locname = "menu07";
            arMenu.l6.sel = "mainmenu\menu07_active";
            arMenu.l6.norm = "mainmenu\menu07_passive";
            arMenu.l6.event = "Updates";
            arMenu.l6.path = LanguageGetLanguage();
        }
        else
        { // обновлений нет
            arMenu.l6.locname = "menu07";
            arMenu.l6.sel = "mainmenu\menu07_none";
            arMenu.l6.norm = "mainmenu\menu07_none";
            arMenu.l6.event = "Updates";
            arMenu.l6.path = LanguageGetLanguage();
        }
    }
