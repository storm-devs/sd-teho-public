...
string GetMoralePicture(float fMoraleValue)
{
    ...
    {
        return "interfaces\flags\flag_1_64.tga.tx";
    }
    if (fMoraleValue >= 50.0)
    {
        return "interfaces\flags\flag_2_64.tga.tx";
    }
    if (fMoraleValue >= 25.0)
    {
        return "interfaces\flags\flag_3_64.tga.tx";
    }
...
string GetExperiencePicture(float fExpValue)
{
    if (fExpValue >= 75.0)
    {
        return "interfaces\stars\Yellow_star1.tga.tx";
    }
    if (fExpValue >= 50.0)
    {
        return "interfaces\stars\Yellow_star2.tga.tx";
    }
    if (fExpValue >= 25.0)
    {
        return "interfaces\stars\Yellow_star3.tga.tx";
    }
