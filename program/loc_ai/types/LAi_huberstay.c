...
void LAi_type_huberstay_Init(aref chr)
{
    ...
    else
    {
        ...
        if (!CheckAttribute(chr, "chr_ai.type.time"))
            chr.chr_ai.type.time = "0";
        if (!CheckAttribute(chr, "chr_ai.type.win_group"))
            chr.chr_ai.type.win_group = "";
        if (!CheckAttribute(chr, "chr_ai.type.win_locator"))
            chr.chr_ai.type.win_locator = "";
        if (!CheckAttribute(chr, "chr_ai.type.map_group"))
            chr.chr_ai.type.map_group = "";
        if (!CheckAttribute(chr, "chr_ai.type.map_locator"))
            chr.chr_ai.type.map_locator = "";
